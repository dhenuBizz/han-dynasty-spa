        ...
        var o = r(1)
            ...
            , y = function (e) {
                ...
                return o.__extends(t, e), t.prototype.normalizeComponentFootprint = function (e) {
                    ...
                    return this.isTimeScale ? (r = [], r.push(s.isInt(s.divideRangeByDuration(this.normalizedUnzonedStart, e, this.labelInterval)) ? "fc-major" : "fc-minor")) : (r = this.getDayClasses(e), r.push("fc-day")), r.unshift(o.getClass("widgetContent")), t && r.push("fc-em-cell"), '<td class="' + r.join(" ") + '" data-date="' + e.format() + '"><div></div></td>'
        ...
        var o = r(1)
            ...
            , c = function (e) {
                ...
                return o.__extends(t, e), t.prototype.renderEventSkeleton = function (e) {
                    ...
                    e.html('<td class="' + t.getClass("widgetContent") + '"> <div> <div class="fc-event-container"></div> </div> </td>'), this.segContainerEl = e.find(".fc-event-container"), this.innerEl = this.bgSegContainerEl = e.find("td > div")
                }, t.prototype.rangeToCoords = function (e) {
