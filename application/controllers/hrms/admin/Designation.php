...
class Designation extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		if(in_array('4',$role_resources_ids)) {
			$data['subview'] = $this->load->view("hrms/admin/designation/designation_list", $data, TRUE);
    ...
    public function designation_list()
     {
		...
		if(!empty($session)){ 
			$this->load->view("hrms/admin/designation/designation_list", $data);
		} else {
			redirect('hrms/admin/');
		}
	 ...
	 public function read()
	{
		...
		if(!empty($session)){ 
			$this->load->view('hrms/admin/designation/dialog_designation', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
	...
	// get company > departments
	 public function get_departments() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/designation/get_departments", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function get_model_departments() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/designation/get_model_departments", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function get_sub_departments() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/designation/get_subdepartments", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	// get departmens > designations
	 public function topdesignation() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/designation/get_designations", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
