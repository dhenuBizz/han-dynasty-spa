...
class Timesheet extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function attendance()
     {
		...
		if(in_array('28',$role_resources_ids)) {
			if(!empty($session)){
			$data['subview'] = $this->load->view("hrms/admin/timesheet/attendance_list", $data, TRUE);
	 ...
	 public function attendance_dashboard()
     {
		...
		if(in_array('423',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/timesheet/attendance_dashboard", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	 ...
	 public function date_wise_attendance()
     {
		...
		if(in_array('29',$role_resources_ids)) {
			if(!empty($session)){ 
			$data['subview'] = $this->load->view("hrms/admin/timesheet/date_wise", $data, TRUE);
			$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	 ...
	 public function update_attendance()
     {
		...
		if(in_array('30',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/timesheet/update_attendance", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	 ...
	 public function import() {
		...
		if(in_array('31',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/timesheet/attendance_import", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	 ...
	 public function index() {
		...
		if(in_array('10',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/timesheet/timesheet_monthly", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	 ...
	 public function timecalendar() {
		...
		if(in_array('261',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/calendar/timecalendar", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	...
	public function import_attendance() {
	 ...
	 public function office_shift() {
		...
		if(in_array('7',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/timesheet/office_shift", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	 ...
	 public function holidays() {
		...
		if(!empty($session)){ 
			$data['subview'] = $this->load->view("hrms/admin/timesheet/holidays", $data, TRUE);
			$this->load->view('hrms/admin/layout/layout_main', $data); //page load
		} else {
			redirect('hrms/admin/');
		}
	 ...
	 public function leave() {
		...
		if(in_array('46',$role_resources_ids) || $reports_to > 0) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/timesheet/leave", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	 ...
	 public function leave_details() {
		...
		if(is_null($result)){
			redirect('hrms/admin/timesheet/leave');
		}
		$edata = array(
			'is_notify' => 0,
		);
		...
		if(in_array('46',$role_resources_ids) || $reports_to > 0) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/timesheet/leave_details", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	 ...
	 public function task_details() {
		...
		if(is_null($result)){
			redirect('hrms/admin/timesheet/tasks');
		}
		...
		if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/timesheet/tasks/task_details", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	 ...
	 public function tasks() {
		...
		if(in_array('45',$role_resources_ids)) {
			if(!empty($session)){ 
			$data['subview'] = $this->load->view("hrms/admin/timesheet/tasks/task_list", $data, TRUE);
			$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	...
	public function task_users() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/timesheet/tasks/get_task_users", $data);
		} else {
			redirect('hrms/admin/');
		}
	...
	public function update_task_status() {
	 ...
	 public function task_list() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/timesheet/leave", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	<div class="progress progress-xs"><div class="progress-bar '.$progress_class.' progress-bar-striped" role="progressbar" aria-valuenow="'.$r->task_progress.'" aria-valuemin="0" aria-valuemax="100" style="width: '.$r->task_progress.'%"></div></div></p>';
				...
				if(in_array('322',$role_resources_ids)) { //view
					$view = '<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_view_details').'"><a href="'.site_url().'hrms/admin/timesheet/task_details/id/'.$r->task_id.'/"><button type="button" class="btn icon-btn btn-xs btn-default waves-effect waves-light"><span class="fa fa-arrow-circle-right"></span></button></a></span>';
				} else {
					$view = '';
				}
			  ...
			  $ttask_date = $this->lang->line('xin_start_date').': '.$psdate.'<br>'.$this->lang->line('xin_end_date').': '.$pedate;				
			   $data[] = array(
					$combhr,
					$task_catname.'<br>'.$this->lang->line('xin_project').': <a href="'.site_url().'hrms/admin/project/detail/'.$r->project_id.'">'.$prj_name.'</a><br>'.$this->lang->line('xin_hours').': '.$r->task_hour,
					$ol.$add_users,
					$ttask_date,
					$status,
	 ...
	 public function comments_list()
     {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/timesheet/tasks/task_details", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
		...
		//
			$link = '<a class="c-user text-black" href="'.site_url().'hrms/admin/employees/detail/'.$r->user_id.'"><span class="underline">'.$employee_name.' ('.$designation_name.')</span></a>';
	...
	public function add_attachment() {
	  ...
	  public function attachment_list()
     {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/timesheet/tasks/task_list", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
    ...
    public function attendance_list()
     {
		...
		$user_info = $this->Xin_model->read_user_info($session['user_id']);
		if(!empty($session)){ 
			$this->load->view("hrms/admin/timesheet/attendance_list", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	// get company > employees
	 public function get_employees() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/timesheet/get_employees", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	// get company > employees
	 public function get_leave_employees() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/timesheet/get_leave_employees", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	// get company > employees leave
	 public function get_employees_leave() {
		...
		$leave_type_id = $this->uri->segment(5);
	...
	// get employee assigned leave types
	 public function get_employee_assigned_leave_types() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/timesheet/get_employee_assigned_leave_types", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	// get company > projects
	 public function get_company_project() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/timesheet/tasks/get_company_project", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	// get company > employees
	 public function get_company_employees() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/timesheet/tasks/get_employees", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	// get company > employees
	 public function get_update_employees() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/timesheet/get_update_employees", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function get_timesheet_employees() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/timesheet/get_timesheet_employees", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
    ...
    public function date_wise_list()
     {
		...
		$user_info = $this->Xin_model->read_user_info($session['user_id']);
		if(!empty($session)){ 
			$this->load->view("hrms/admin/timesheet/date_wise", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	//	$full_name = $r->first_name.' '.$r->last_name;	
	 ...
	 public function update_attendance_list() {
		...
		if(!empty($session)){ 
			$this->load->view("hrms/admin/timesheet/update_attendance", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function office_shift_list() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/timesheet/office_shift", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function holidays_list() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/timesheet/holidays", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function leave_list() {
		...
		foreach($leave->result() as $r) {
			...
			if(in_array('290',$role_resources_ids) || $user_info[0]->user_role_id==1 || $reports_to > 0) { //view
				$view = '<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_view_details').'"><a href="'.site_url().'hrms/admin/timesheet/leave_details/id/'.$r->leave_id.'/"><button type="button" class="btn icon-btn btn-xs btn-default waves-effect waves-light"><span class="fa fa-arrow-circle-right"></span></button></a></span>';
			} else {
				$view = '';
			}
			$combhr = $edit.$view.$delete;
	...
	public function update_attendance_add()
	{
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view('hrms/admin/timesheet/dialog_attendance', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
	...
	public function read_task_record()
	{
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view('hrms/admin/timesheet/tasks/dialog_task', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
	...
	public function read_leave_record()
	{
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view('hrms/admin/timesheet/dialog_leave', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
	...
	public function read_holiday_record()
	{
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view('hrms/admin/timesheet/dialog_holiday', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
	...
	public function read_shift_record()
	{
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view('hrms/admin/timesheet/dialog_office_shift', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
	...
	public function read_map_info()
	{
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view('hrms/admin/timesheet/dialog_read_map', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
