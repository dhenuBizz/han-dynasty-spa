   ...
   /*Function to set JSON output*/
	...
	public function accounting_dashboard()
     {
		...
		if(in_array('72',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/accounting/accounting_dashboard", $data, TRUE);
	...
	public function deposit() {
		...
		if(in_array('75',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/accounting/deposit_list", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	...
	public function transfer() {
		...
		if(in_array('77',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/accounting/transfer_list", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	...
	public function expense() {
		...
		if(in_array('76',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/accounting/expense_list", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	...
	// get company > employees
	 public function get_employees() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/get_employees", $data);
		} else {
			redirect('hrms/admin/');
		}
	 ...
	 public function get_company_expense_types() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/get_company_expense_types", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function get_expense_types() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/get_expense_types", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	public function payers() {
		...
		if(in_array('81',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/accounting/payers_list", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	...
	public function payees() {
		...
		if(in_array('80',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/accounting/payees_list", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	...
	public function bank_cash() {
		...
		if(in_array('72',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/accounting/bank_cash_list", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	...
	public function account_balances() {
		...
		if(in_array('73',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/accounting/account_balances", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	...
	public function transactions() {
		...
		if(in_array('78',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/accounting/transaction_list", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	 ...
	 public function read() {
		...
		if(!empty($session)){ 
			$this->load->view('hrms/admin/accounting/dialog_accounting', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
	...
	public function payers_list()
     {
		...
		$data['title'] = $this->Xin_model->site_title();
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/payers_list", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	public function payees_list()
     {
		...
		$data['title'] = $this->Xin_model->site_title();
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/payees_list", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	public function bank_cash_list()
     {
		...
		$data['title'] = $this->Xin_model->site_title();
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/bank_cash_list", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
		...
		$data = array();
          ...
          foreach($bankcash->result() as $r) {
			...
			if(!is_null($bank_cash)){
				$account = '<a data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_acc_ledger_view').'" href="'.site_url('hrms/admin/accounting/accounts_ledger/'.$r->bankcash_id.'').'" target="_blank">'.$r->account_name.'</a>';
			} else {
	...
	public function account_balances_list()
     {
		...
		$data['title'] = $this->Xin_model->site_title();
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/account_balances", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	public function deposit_list() {
		...
		$data['title'] = $this->Xin_model->site_title();
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/deposit_list", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	public function expense_list()
     {
		...
		$data['title'] = $this->Xin_model->site_title();
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/expense_list", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	public function transaction_list()
     {
		...
		$data['title'] = $this->Xin_model->site_title();
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/transaction_list", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
		...
		$balance2 = 0;
          foreach($transaction->result() as $r) {
			...
			$acc_type = $this->Finance_model->read_bankcash_information($r->account_id);
			if(!is_null($acc_type)){
				$account = '<a href="'.site_url('hrms/admin/accounting/accounts_ledger/'.$r->account_id.'').'" title="'.$this->lang->line('xin_acc_ledger_view').'" target="_blank">'.$acc_type[0]->account_name.'</a>';
			} else {
				$account = '--';	
			}
			//
	...
	public function accounts_ledger() {
		...
		if(!empty($session)){ 
			if(in_array('4',$role_resources_ids)) {
				$data['subview'] = $this->load->view("hrms/admin/accounting/ledger_account_list", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/dashboard');
			}
	...
	public function ledger_accounts() {
		...
		if(!empty($session)){ 
			if(in_array('4',$role_resources_ids)) {
				$data['subview'] = $this->load->view("hrms/admin/accounting/full_ledger_account_list", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/dashboard');
			}
	...
	public function account_statement() {
		...
		if(in_array('83',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/accounting/report_account_statement", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	...
	public function expense_report() {
		...
		if(in_array('84',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/accounting/report_expense", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	...
	public function income_report() {
		...
		if(in_array('85',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/accounting/report_income", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	...
	public function transfer_report() {
		...
		if(in_array('86',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/accounting/report_transfer", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	...
	public function report_statement_list() {
		...
		$data['title'] = $this->Xin_model->site_title();
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/report_account_statement", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function get_statement_footer() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/footer/get_statement_footer", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	public function report_expense_list()
     {
		...
		$data['title'] = $this->Xin_model->site_title();
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/report_expense", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function get_expense_footer() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/footer/get_expense_footer", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	public function report_income_list() {
		...
		$data['title'] = $this->Xin_model->site_title();
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/report_income", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	public function report_transfer_list() {
		...
		$data['title'] = $this->Xin_model->site_title();
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/report_transfer", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	public function accounts_ledger_list() {
		...
		$data['title'] = $this->Xin_model->site_title();
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/full_ledger_account_list", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function get_accounts_ledger_footer() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/footer/get_ledger_accounts_footer", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	public function bankwise_transactions_list() {
	 ...
	 public function get_income_footer() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/footer/get_income_footer", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function get_transfer_footer() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/accounting/footer/get_transfer_footer", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function get_all_payee() {
		...
		if(!empty($session)){ 
			...
			$this->load->view("hrms/admin/accounting/get_all_payee", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
