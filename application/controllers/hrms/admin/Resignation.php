...
class Resignation extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		if(in_array('16',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/resignation/resignation_list", $data, TRUE);
    ...
    public function resignation_list()
     {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/resignation/resignation_list", $data);
		} else {
			redirect('hrms/admin/');
		}
	...
	// get company > employees
	 public function get_employees() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/resignation/get_employees", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function read()
	{
		...
		if(!empty($session)){ 
			$this->load->view('hrms/admin/resignation/dialog_resignation', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
