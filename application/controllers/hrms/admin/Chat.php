...
class Chat extends MY_Controller
{
   ...
   /*Function to set JSON output*/
	...
	public function index() {
		...
		$data['subview'] = $this->load->view("hrms/admin/chatbox/chatbox", $data, TRUE);
	...
	public function chat_read()
	{
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view('hrms/admin/chatbox/single_chat', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
	public function department_chat_read()
	{
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view('hrms/admin/chatbox/department_chat', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
	public function location_chat_read()
	{
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view('hrms/admin/chatbox/location_chat', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
		  ...
		  $("#xin-form").submit(function(e){
			...
			$.ajax({
				...
				success: function(JSON)
				{
					...
					var siteUrl = "'.site_url('hrms/admin/chat/set_chatbox').'?from_id='.$fid.'&to_id='.$tid.'";
