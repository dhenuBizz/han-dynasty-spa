...
class Location extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		if(in_array('6',$role_resources_ids)) {
			if(!empty($session)){ 
			$data['subview'] = $this->load->view("hrms/admin/location/location_list", $data, TRUE);
    ...
    public function location_list()
     {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/location/location_list", $data);
		} else {
			redirect('hrms/admin/');
		}
	...
	// get company > employees
	 public function get_employees() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/location/get_employees", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	public function read()
	{
       ...
       // $data['all_countries'] = $this->xin_model->get_countries();
		...
		if(!empty($session)){ 
			$this->load->view('hrms/admin/location/dialog_location', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
	...
	public function read_info()
	{
       ...
       // $data['all_countries'] = $this->xin_model->get_countries();
		...
		if(!empty($session)){ 
			$this->load->view('hrms/admin/location/view_location', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
