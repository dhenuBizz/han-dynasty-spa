...
class Training_type extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		if(in_array('55',$role_resources_ids)) {
			if(!empty($session)){
				$data['subview'] = $this->load->view("hrms/admin/training/training_type", $data, TRUE);
    ...
    public function type_list() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/training/training_type", $data);
		} else {
			redirect('hrms/admin/');
		}
	...
	public function read()
	{
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view('hrms/admin/training/dialog_training_type', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
