...
class Transfers extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		if(in_array('15',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/transfers/transfer_list", $data, TRUE);
    ...
    public function transfer_list()
     {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/transfers/transfer_list", $data);
		} else {
			redirect('hrms/admin/');
		}
	 ...
	 public function read()
	{
		...
		if(!empty($session)){ 
			$this->load->view('hrms/admin/transfers/dialog_transfer', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
	...
	// get company > departments
	 public function get_departments() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/transfers/get_departments", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function get_locations() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/transfers/get_locations", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function get_employees() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/transfers/get_employees", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
