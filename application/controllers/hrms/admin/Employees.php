...
class Employees extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		if(in_array('13',$role_resources_ids) || $reports_to > 0) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/employees/employees_list", $data, TRUE);
	 ...
	 public function staff_dashboard()
     {
		...
		if(in_array('422',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/employees/staff_dashboard", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	...
	public function hr() {
		...
		$config['base_url'] = site_url() . "hrms/admin/employees/hr";
	   ...
	   // $config['num_links'] = 2;
		...
		if(in_array('88',$role_resources_ids) || $reports_to > 0) {
			$data['subview'] = $this->load->view("hrms/admin/employees/directory", $data, TRUE);
			$this->load->view('hrms/admin/layout/layout_main', $data); //page load
		} else {
			redirect('hrms/admin/dashboard');
		}	  
    ...
    public function employees_list()
     {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/employees/employees_list", $data);
		} else {
			redirect('hrms/admin/');
		}
        ...
        foreach($employee->result() as $r) {		  
			...
			if(in_array('202',$role_resources_ids)) {
				$view_opt = ' <span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_view_details').'"><a href="'.site_url().'hrms/admin/employees/detail/'.$r->user_id.'"><button type="button" class="btn icon-btn btn-xs btn-default waves-effect waves-light"><span class="fa fa-arrow-circle-right"></span></button></a></span>';
			} else {
				$view_opt = '';
			}
			...
			$employee_name .= '<br><small class="text-muted hrsale-text-info-margin"><i><a target="_blank" href="'.site_url('hrms/admin/employees/download_profile/').$r->user_id.'">'.$this->lang->line('xin_download_profile_title').' <i class="fa fa-arrow-circle-right"></i></a><i></i></i></small>';
			}
	 ...
	 public function employees_cards_list()
     {
	  ...
	  public function detail() {
		...
		$data['subview'] = $this->load->view("hrms/admin/employees/employee_detail", $data, TRUE);
		$this->load->view('hrms/admin/layout/layout_main', $data); //page load
	...
	// get company > departments
	 public function get_departments() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/employees/get_departments", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	public function dialog_contact() {
		...
		if(!empty($session)){ 
			$this->load->view('hrms/admin/employees/dialog_employee_details', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
	 ...
	 public function get_company_elocations() {
		...
		$data['title'] = $this->Xin_model->site_title();
		$keywords = preg_split("/[\s,]+/", $this->uri->segment(5));
		if(is_numeric($keywords[0])) {
			...
			if(!empty($session)){ 
				...
				$this->load->view("hrms/admin/employees/get_company_elocations", $data);
			} else {
				redirect('hrms/admin/');
			}
		}
	 ...
	 public function get_company_office_shifts() {
		...
		if(is_numeric($keywords[0])) {
			...
			if(!empty($session)){ 
				$data = $this->security->xss_clean($data);
				$this->load->view("hrms/admin/employees/get_company_office_shifts", $data);
			} else {
				redirect('hrms/admin/');
			}
		}
	 ...
	 public function get_location_departments() {
		...
		if(is_numeric($keywords[0])) {
			...
			if(!empty($session)){ 
				$data = $this->security->xss_clean($data);
				$this->load->view("hrms/admin/employees/get_location_departments", $data);
			} else {
				redirect('hrms/admin/');
			}
		}
	...
	public function dialog_emp_overtime() {
	 ...
	 public function designation() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/employees/get_designations", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function get_sub_departments() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/employees/get_sub_departments", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function read()
	{
		...
		if(!empty($session)){ 
			$this->load->view('hrms/admin/warning/dialog_warning', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
	...
	public function security_level_list() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/employees/employee_detail", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	public function documents() {
        ...
        foreach($documents->result() as $r) {
			...
			if($r->document_file!='' && $r->document_file!='no file') {
			 $functions = '<span data-toggle="tooltip" data-placement="top" title="Download"><a href="'.site_url().'hrms/admin/download?type=document&filename='.$r->document_file.'"><button type="button" class="btn btn-secondary btn-sm m-b-0-0 waves-effect waves-light" title="'.$this->lang->line('xin_download').'"><i class="fa fa-download"></i></button></a></span>';
			 } else {
				 $functions ='';
			 }
	...
	// import > employees
	 public function import()
     {
		...
		if(in_array('92',$role_resources_ids)) {
			if(!empty($session)){ 
				$data['subview'] = $this->load->view("hrms/admin/employees/employes_import", $data, TRUE);
				$this->load->view('hrms/admin/layout/layout_main', $data); //page load
			} else {
				redirect('hrms/admin/');
			}
	...
	// get company > locations
	 ...
	 public function filter_location_fdepartments() {
		...
		if(is_numeric($keywords[0])) {
			...
			if(!empty($session)){ 
				$data = $this->security->xss_clean($data);
				$this->load->view("hrms/admin/filter/filter_location_fdepartments", $data);
			} else {
				redirect('hrms/admin/');
			}
		}
	 ...
	 public function filter_location_fdesignation() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/filter/filter_location_fdesignation", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	  ...
	  public function expired_documents() {
		...
		if(in_array('400',$role_resources_ids)) {
			$data['subview'] = $this->load->view("hrms/admin/employees/expired_documents_list", $data, TRUE);
			$this->load->view('hrms/admin/layout/layout_main', $data); //page load
		} else {
			redirect('hrms/admin/dashboard');
		}
	...
	public function expired_documents_list() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/employees/expired_documents_list", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	...
	//	$id = $this->uri->segment(4);
		...
		if($r->document_file!='' && $r->document_file!='no file') {
		 	$functions = '<span data-toggle="tooltip" data-placement="top" title="Download"><a href="'.site_url().'hrms/admin/download?type=document/immigration&filename='.$r->document_file.'"><button type="button" class="btn btn-secondary btn-sm m-b-0-0 waves-effect waves-light" title="'.$this->lang->line('xin_download').'"><i class="fa fa-download"></i></button></a></span>';
		 } else {
			 $functions ='';
		 }
		$data[] = array(
