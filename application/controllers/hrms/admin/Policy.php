...
class Policy extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		$data['subview'] = $this->load->view("hrms/admin/policy/policy_list", $data, TRUE);
    ...
    public function policy_list()
     {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/policy/policy_list", $data);
		} else {
			redirect('hrms/admin/');
		}
	 ...
	 public function read()
	{
		...
		if(!empty($session)){ 
			$this->load->view('hrms/admin/policy/dialog_policy', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
