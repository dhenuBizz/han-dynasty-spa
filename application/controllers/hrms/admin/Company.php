...
class Company extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		if(in_array('5',$role_resources_ids)) {
			$data['subview'] = $this->load->view("hrms/admin/company/company_list", $data, TRUE);
	  ...
	  public function official_documents() {
		...
		$role_resources_ids = $this->Xin_model->user_role_resource();
		if(in_array('5',$role_resources_ids)) {
			$data['subview'] = $this->load->view("hrms/admin/company/official_document_list", $data, TRUE);
			$this->load->view('hrms/admin/layout/layout_main', $data); //page load
		} else {
			redirect('hrms/admin/dashboard');
		}
    ...
    public function document_list()
     {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/company/official_document_list", $data);
		} else {
			redirect('hrms/admin/');
		}
		...
		$data = array();
          ...
          foreach($company->result() as $r) {
			...
			$doc_view='<a href="'.site_url('hrms/admin/download?type=company/official_documents&filename=').$r->document.'">'.$this->lang->line('xin_view').'</a>';
	 ...
	 public function company_list()
     {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/company/company_list", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
	 ...
	 public function read() {
       ...
       // $data['all_countries'] = $this->xin_model->get_countries();
		...
		$this->load->view('hrms/admin/company/dialog_company', $data);
	}
	...
	public function read_document() {
       ...
       // $data['all_countries'] = $this->xin_model->get_countries();
		...
		$this->load->view('hrms/admin/company/dialog_official_document', $data);
	}
	...
	public function read_info()
	{
       ...
       // $data['all_countries'] = $this->xin_model->get_countries();
		...
		$this->load->view('hrms/admin/company/view_company.php', $data);
	}
