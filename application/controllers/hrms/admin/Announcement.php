...
class Announcement extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		$data['subview'] = $this->load->view("hrms/admin/announcement/announcement_list", $data, TRUE);
    ...
    public function announcement_list()
     {
		...
		$session = $this->session->userdata('username');
		$this->load->view("hrms/admin/announcement/announcement_list", $data);
	 ...
	 public function read()
	{
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view('hrms/admin/announcement/dialog_announcement', $data);
		} else {
			redirect('hrms/admin/');
		}
	}
	 ...
	 public function get_company_elocations_dialog() {
		...
		if(is_numeric($keywords[0])) {
			...
			if(!empty($session)){ 
				...
				$this->load->view("hrms/admin/announcement/get_company_elocations_dialog", $data);
			} else {
				redirect('hrms/admin/');
			}
		}
	...
	// get location > departments
	 public function get_location_departments_dialog() {
		...
		if(is_numeric($keywords[0])) {
			...
			if(!empty($session)){ 
				$data = $this->security->xss_clean($data);
				$this->load->view("hrms/admin/announcement/get_location_departments_dialog", $data);
			} else {
				redirect('hrms/admin/');
			}
		}
	 ...
	 public function get_departments() {
		...
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
			$this->load->view("hrms/admin/announcement/get_departments", $data);
		} else {
			redirect('hrms/admin/');
		}
		// Datatables Variables
