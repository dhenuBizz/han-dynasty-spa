              ...
              <div class="authfy-panel panel-login text-center active">
                ...
                <div class="row">
                  <div class="col-xs-12 col-sm-12">
                    ...
                    <?php echo form_open('hrms/admin/auth/login', $attributes, $hidden);?>
                      <?php
                      ...
                      <div class="row remember-row">
                        ...
                        <div class="col-xs-6 col-sm-6">
                          <p class="forgotPwd">
                            <a href="<?php echo site_url('hrms/admin/auth/forgot_password');?>" class="lnk-toggler"><?php echo $this->lang->line('xin_forgot_password_link');?></a>
                          </p>
                        </div>
                      </div> <!-- ./remember-row -->
                      <div class="form-group">
