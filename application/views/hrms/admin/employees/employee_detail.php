                  ...
                  <div class="tab-content">
                    <div class="tab-pane active current-tab <?php echo $get_animate;?>" id="user_basic_info">
                      ...
                      <div class="box-body">
                        ...
                        <?php echo form_open_multipart('hrms/admin/employees/basic_info', $attributes, $hidden);?>
                        <div class="bg-white">
                          <div class="row">
                            <div class="col-md-6">
                    ...
                    <div class="tab-pane current-tab <?php echo $get_animate;?>" id="immigration" style="display:none;">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <?php echo form_open_multipart('hrms/admin/employees/immigration_info', $attributes, $hidden);?>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="tab-pane current-tab <?php echo $get_animate;?>" id="contacts" style="display:none;">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <?php echo form_open('hrms/admin/employees/contact_info', $attributes, $hidden);?>
                        <?php
						  $data_usr1 = array(
								'type'  => 'hidden',
								'name'  => 'user_id',
                    ...
                    <div class="tab-pane current-tab <?php echo $get_animate;?>" id="documents" style="display:none;">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <?php echo form_open_multipart('hrms/admin/employees/document_info', $attributes, $hidden);?>
                        <?php
						  $data_usr2 = array(
								'type'  => 'hidden',
								'name'  => 'user_id',
                    ...
                    <div class="tab-pane current-tab <?php echo $get_animate;?>" id="qualification" style="display:none;">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <?php echo form_open('hrms/admin/employees/qualification_info', $attributes, $hidden);?>
                        <?php
						  $data_usr3 = array(
								'type'  => 'hidden',
								'name'  => 'user_id',
                    ...
                    <div class="tab-pane current-tab <?php echo $get_animate;?>" id="work-experience" style="display:none;">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <?php $hidden = array('u_basic_info' => 'UPDATE');?>
                        <?php echo form_open('hrms/admin/employees/work_experience_info', $attributes, $hidden);?>
                        <?php
							  $data_usr4 = array(
									'type'  => 'hidden',
									'name'  => 'user_id',
                    ...
                    <div class="tab-pane current-tab <?php echo $get_animate;?>" id="bank-account" style="display:none;">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <?php $hidden = array('u_basic_info' => 'UPDATE');?>
                        <?php echo form_open('hrms/admin/employees/bank_account_info', $attributes, $hidden);?>
                        <?php
						  $data_usr4 = array(
								'type'  => 'hidden',
								'name'  => 'user_id',
                    ...
                    <div class="tab-pane current-tab <?php echo $get_animate;?>" id="social-networking" style="display:none;">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <?php $hidden = array('user_id' => $user_id, 'u_basic_info' => 'UPDATE');?>
                        <?php echo form_open('hrms/admin/employees/social_info', $attributes, $hidden);?>
                        <div class="bg-white">
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                    ...
                    <div class="tab-pane current-tab <?php echo $get_animate;?>" id="change-password" style="display:none;">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <?php $hidden = array('u_basic_info' => 'UPDATE');?>
                        <?php echo form_open('hrms/admin/employees/change_password', $attributes, $hidden);?>
                        <?php
						  $data_usr5 = array(
								'type'  => 'hidden',
								'name'  => 'user_id',
                    ...
                    <div class="tab-pane current-tab <?php echo $get_animate;?>" id="security_level" style="display:none;">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <?php $hidden = array('u_basic_info' => 'UPDATE');?>
                        <?php echo form_open('hrms/admin/employees/add_security_level', $attributes, $hidden);?>
                        <?php
						  $data_usr4 = array(
							'type'  => 'hidden',
							'name'  => 'user_id',
                    ...
                    <div class="tab-pane current-tab <?php echo $get_animate;?>" id="contract" style="display:none;">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <?php $hidden = array('u_basic_info' => 'UPDATE');?>
                        <?php echo form_open('hrms/admin/employees/contract_info', $attributes, $hidden);?>
                        <?php
						  $data_usr4 = array(
							'type'  => 'hidden',
							'name'  => 'user_id',
                ...
                <div class="tab-content">
                  <div class="tab-pane  <?php echo $get_animate;?> active" id="profile-picture">
                    <div class="box-body pb-2">
                      ...
                      <?php echo form_open_multipart('hrms/admin/employees/profile_picture', $attributes, $hidden);?>
                      <?php
						  $data_usr = array(
								'type'  => 'hidden',
								'name'  => 'user_id',
                  ...
                  <div class="tab-content active">
                    <div class="tab-pane <?php echo $get_animate;?> salary-current-tab active" id="salary">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <?php $hidden = array('user_id' => $user_id, 'u_basic_info' => 'UPDATE');?>
                        <?php echo form_open('hrms/admin/employees/update_salary_option', $attributes, $hidden);?>
                        <div class="bg-white">
                          <div class="row">
                            <div class="col-md-4">
                              <div class="form-group">
                    ...
                    <div class="tab-pane <?php echo $get_animate;?> salary-current-tab" id="set_allowances">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <?php $hidden = array('u_basic_info' => 'UPDATE');?>
                        <?php echo form_open('hrms/admin/employees/employee_allowance_option', $attributes, $hidden);?>
                        <?php
						  $data_usr4 = array(
							'type'  => 'hidden',
							'name'  => 'user_id',
                    ...
                    <div class="tab-pane <?php echo $get_animate;?> salary-current-tab" id="commissions" style="display:none;">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <?php $hidden = array('u_basic_info' => 'UPDATE');?>
                        <?php echo form_open('hrms/admin/employees/employee_commissions_option', $attributes, $hidden);?>
                        <?php
							  $data_usr4 = array(
								'type'  => 'hidden',
								'name'  => 'user_id',
                    ...
                    <div class="tab-pane <?php echo $get_animate;?> salary-current-tab" id="loan_deductions" style="display:none;">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <?php $hidden = array('u_basic_info' => 'UPDATE');?>
                        <?php echo form_open('hrms/admin/employees/employee_loan_info', $attributes, $hidden);?>
                        <?php
							  $data_usr4 = array(
									'type'  => 'hidden',
									'name'  => 'user_id',
                    ...
                    <div class="tab-pane <?php echo $get_animate;?> salary-current-tab" id="statutory_deductions" style="display:none;">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <?php $hidden = array('u_basic_info' => 'UPDATE');?>
                        <?php echo form_open('hrms/admin/employees/set_statutory_deductions', $attributes, $hidden);?>
                        <?php
							  $data_usr4 = array(
								'type'  => 'hidden',
								'name'  => 'user_id',
                    ...
                    <div class="tab-pane <?php echo $get_animate;?> salary-current-tab" id="other_payment" style="display:none;">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <?php $hidden = array('u_basic_info' => 'UPDATE');?>
                        <?php echo form_open('hrms/admin/employees/set_other_payments', $attributes, $hidden);?>
                        <?php
							  $data_usr4 = array(
								'type'  => 'hidden',
								'name'  => 'user_id',
                    ...
                    <div class="tab-pane <?php echo $get_animate;?> salary-current-tab" id="overtime" style="display:none;">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <?php $hidden = array('u_basic_info' => 'UPDATE');?>
                        <?php echo form_open('hrms/admin/employees/set_overtime', $attributes, $hidden);?>
                        <?php
						  $data_usr4 = array(
								'type'  => 'hidden',
								'name'  => 'user_id',
                        ...
                        <div class="row">
                          <?php $leave_categories_ids = explode(',',$leave_user[0]->leave_categories); ?>
                            ...
                            <?php
                                $hlfcount =0;
                                //$count_l =0;
                                $leave_halfday_cal = employee_leave_halfday_cal($type->leave_type_id,$this->uri->segment(5));
                                foreach($leave_halfday_cal as $lhalfday):
                                    $hlfcount += 0.5;
                                endforeach;
                                
                                $count_l = count_leaves_info($type->leave_type_id,$this->uri->segment(5));
                        ...
                        <div class="box-datatable table-responsive">
                          <table class="datatables-demo table table-striped table-bordered xin_hrsale_table" id="xin_hr_table">
							...
							if(in_array('290',$role_resources_ids)) { //view
								$view = '<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_view_details').'"><a href="'.site_url().'hrms/admin/timesheet/leave_details/id/'.$r->leave_id.'/" target="_blank"><button type="button" class="btn icon-btn btn-xs btn-default waves-effect waves-light"><span class="fa fa-arrow-circle-right"></span></button></a></span>';
							} else {
								$view = '';
							}
							$combhr = $view;
                        ...
                        <div class="box-datatable table-responsive">
                          <table class="datatables-demo table table-striped table-bordered xin_hrsale_table">
							...
							if(in_array('344',$role_resources_ids)) { //view
								$view = '<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_view_details').'"><a href="'.site_url().'hrms/admin/training/details/'.$r->training_id.'" target="_blank"><button type="button" class="btn icon-btn btn-xs btn-default waves-effect waves-light"><span class="fa fa-arrow-circle-right"></span></button></a></span>';
							} else {
								$view = '';
							}
							$combhr = $view;
                          ...
                          <table class="datatables-demo table table-striped table-bordered xin_hrsale_table">
							...
							if($r->ticket_priority==1): $priority = $this->lang->line('xin_low'); elseif($r->ticket_priority==2): $priority = $this->lang->line('xin_medium'); elseif($r->ticket_priority==3): $priority = $this->lang->line('xin_high'); elseif($r->ticket_priority==4): $priority = $this->lang->line('xin_critical');  endif;
							 ...
							 $_created_at = $edate. ' '. $created_at;
								...
								$view = '<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_view_details').'"><a href="'.site_url().'hrms/admin/tickets/details/'.$r->ticket_id.'" target="_blank"><button type="button" class="btn icon-btn btn-xs btn-default waves-effect waves-light"><span class="fa fa-arrow-circle-right"></span></button></a></span>';
                      ...
                      <div class="box-body">
                        <div class="box-datatable table-responsive">
                          <table class="datatables-demo table table-striped table-bordered xin_hrsale_table" id="xin_hr_table">
							...
							$project_summary = '<div class="text-semibold"><a href="'.site_url().'hrms/admin/project/detail/'.$r->project_id . '" target="_blank">'.$r->title.'</a></div><div class="text-muted">'.$r->summary.'</div>';
							?>
                            <tr>
                        ...
                        <div class="box-datatable table-responsive">
                          <table class="datatables-demo table table-striped table-bordered xin_hrsale_table">
							...
							if(in_array('322',$role_resources_ids)) { //view
								$view = '<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_view_details').'"><a href="'.site_url().'hrms/admin/timesheet/task_details/id/'.$r->task_id.'/" target="_blank"><button type="button" class="btn icon-btn btn-xs btn-default waves-effect waves-light"><span class="fa fa-arrow-circle-right"></span></button></a></span>';
							} else {
								$view = '';
							}
							$combhr = $view;
                      ...
                      <div class="box-body">
                        <div class="box-datatable table-responsive">
                          <table class="datatables-demo table table-striped table-bordered xin_hrsale_table" id="xin_hr_table">
							...
							$payslip = '<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_view').'"><a href="'.site_url().'hrms/admin/payroll/payslip/id/'.$r->payslip_key.'"><button type="button" class="btn icon-btn btn-xs btn-default waves-effect waves-light"><span class="fa fa-arrow-circle-right"></span></button></a></span><span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_download').'"><a href="'.site_url().'hrms/admin/payroll/pdf_create/p/'.$r->payslip_key.'"><button type="button" class="btn icon-btn btn-xs btn-default waves-effect waves-light"><span class="fa fa-download"></span></button></a></span>';
