  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-12">
        ...
        <?php echo form_open('hrms/admin/employees/hr', $attributes, $hidden);?>
        <?php
			$data = array(
			  'type'        => 'hidden',
    ...
    <div class="box box-body">
      <div class="text-center"> <a href="#"> <img class="hr-user-img user-img-xin rounded-circle xin-mb-5" src="<?php echo $u_file;?>" alt="<?php echo $employee->first_name;?> <?php echo $employee->last_name;?>"> </a>
        <h3 class="xin-mb-5 emp-name">
          ...
          <a href="<?php echo site_url('hrms/admin/employees/detail')?>/<?php echo $employee->user_id;?>"><?php echo $employee->first_name;?> <?php echo $employee->last_name;?></a>
          <?php } else {?>
        ...
        <?php if(in_array('202',$role_resources_ids)) {?>
        <a href="<?php echo site_url('hrms/admin/employees/detail')?>/<?php echo $employee->user_id;?>" class="btn btn-rounded btn-primary btn-sm" style="background-color: #541728 !important"><?php echo $this->lang->line('xin_view_invoice_more');?> <i class="fa fa-arrow-circle-right"></i></a> <a href="<?php echo site_url('hrms/admin/employees/download_profile')?>/<?php echo $employee->user_id;?>" class="btn btn-rounded btn-primary btn-sm" style="background-color: #541728 !important" target="_blank"><?php echo $this->lang->line('xin_profile');?> <i class="fa fa-download"></i></a>
        <?php } else {?>
        <?php } ?>
      </div>
    </div>
