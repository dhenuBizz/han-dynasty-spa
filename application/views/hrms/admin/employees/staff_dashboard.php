...
<div class="row <?php echo $get_animate;?>">
 <div class="col-xl-6 col-md-4 col-12 hr-mini-state">
    ...
    <div class="info-box hrsalle-mini-stat"> <span class="info-box-icon bg-primary"  style="background-color: #541728 !important"><i class="fa fa-user"></i></span>
  ...
  <?php $all_sal = total_salaries_paid();?>
    <a class="text-muted" href="<?php echo site_url('hrms/admin/payroll/generate_payslip/');?>">
    <div class="info-box hrsalle-mini-stat"> <span class="info-box-icon bg-green"  style="background-color: #541728 !important"><i class="fa fa-money"></i></span>
  ...
  <!-- <div class="col-xl-6 col-md-3 col-12 hr-mini-state">
    <a class="text-muted" href="<?php echo site_url('hrms/admin/awards');?>">
  ...
  <div class="col-xl-6 col-md-4 col-12 hr-mini-state">
    ...
    <div class="info-box hrsalle-mini-stat"> <span class="info-box-icon bg-yellow"  style="background-color: #541728 !important"><i class="fa fa-calendar"></i></span>
