			...
			success: function(JSON)
			{
				if (JSON.error != '') {
					...
					var xin_table_document = $('#xin_table_document').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/expired_documents_list") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
			...
			success: function(JSON)
			{
				if (JSON.error != '') {
					...
					var xin_table_immigration = $('#xin_table_imgdocument').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/expired_immigration_list") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open_multipart('hrms/admin/company/update_official_document/'.$document_id, $attributes, $hidden);?>
  <div class="modal-body">
<div class="form-body">
  <div class="row">
	<div class="col-md-6">
		...
		<div class="row">
		  <div class="col-md-6">
			<div class="form-group">
              ...
              <?php echo $doc_view='<a href="'.site_url('hrms/admin/download?type=company/official_documents&filename=').$document.'">'.$this->lang->line('xin_view').'</a>';?>
			</div>
		  </div>
		</div>
	  </div>
				...
				success: function(JSON)
				{
					if (JSON.error != '') {
						...
						var xxin_table = $('#xin_table_company_license').dataTable({
							"bDestroy": true,
							"ajax": {
								url : "<?php echo site_url("hrms/admin/employees/exp_company_license_list") ?>",
								type : 'GET'
							},
							"fnDrawCallback": function(settings){
							$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open_multipart('hrms/admin/assets/update_asset/'.$assets_id, $attributes, $hidden);?>
  <div class="modal-body">
    <div class="row">
      <div class="col-md-6">
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class='form-group'>
              ...
              <img src="<?php echo base_url().'uploads/asset_image/'.$asset_image;?>" width="70px" id="u_file"> <a href="<?php echo site_url()?>hrms/admin/download?type=asset_image&filename=<?php echo $asset_image;?>"><?php echo $this->lang->line('xin_download');?></a>
              <?php } else {?>
              <p>&nbsp;</p>
              <?php } ?>
            </div>
      ...
      <div class="col-md-4">
        <div class="form-group">
          <label for="<?php echo $mattribute->attribute;?>"><?php echo $mattribute->attribute_label;?>
            <?php if($attr_val!=''):?>
            <a href="<?php echo site_url('hrms/admin/download');?>?type=custom_files&filename=<?php echo $attr_val;?>"><?php echo $this->lang->line('xin_download');?></a>
            <?php endif;?>
          </label>
			...
			success: function(JSON)
			{
				if (JSON.error != '') {
					...
					var xin_table = $('#xin_table_assets_warranty').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/assets_warranty_list"); ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
