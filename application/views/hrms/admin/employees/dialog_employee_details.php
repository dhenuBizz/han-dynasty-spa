...
<?php echo form_open('hrms/admin/employees/e_contact_info', $attributes, $hidden);?>
<?php
$edata_usr1 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
				...
				if (JSON.error != '') {
					...
					// On page load: table_contacts
					 var xin_table_contact = $('#xin_table_contact').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/contacts") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
...
<?php echo form_open_multipart('hrms/admin/employees/e_document_info', $attributes, $hidden);?>
<?php
$edata_usr3 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
    ...
    <div class="col-md-6">
      <div class="form-group">
        <fieldset class="form-group">
          ...
          <br />
          <a href="<?php echo site_url('hrms/admin/download/');?>?type=document&filename=<?php echo $document_file;?>"><?php echo $document_file;?></a>
          <?php } ?>
        </fieldset>
      </div>
    </div>
			...
			success: function(JSON)
			{
				if (JSON.error != '') {
					...
					var xin_table_document = $('#xin_table_document').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/documents") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php $hidden = array('u_document_info' => 'UPDATE');?>
<?php echo form_open_multipart('hrms/admin/employees/e_immigration_info', $attributes, $hidden);?>
<?php
$edata_usr5 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
    ...
    <div class="col-md-6">
      <div class="form-group">
        <fieldset class="form-group">
          ...
          <?php if($document_file!='' && $document_file!='no file') {?>
          <br />
          <a href="<?php echo site_url('hrms/admin/download/');?>?type=document/immigration&filename=<?php echo $document_file;?>"><?php echo $document_file;?></a>
          <?php } ?>
        </fieldset>
      </div>
    </div>
			...
			success: function(JSON)
			{
				if (JSON.error != '') {
					...
					var xin_table_immigration = $('#xin_table_imgdocument').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/immigration") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php $hidden = array('u_basic_info' => 'UPDATE');?>
<?php echo form_open('hrms/admin/employees/e_qualification_info', $attributes, $hidden);?>
<?php
$edata_usr7 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_qualification = $('#xin_table_qualification').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/qualification") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php $hidden = array('u_basic_info' => 'UPDATE');?>
<?php echo form_open('hrms/admin/employees/e_work_experience_info', $attributes, $hidden);?>
<?php
$edata_usr7 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_work_experience = $('#xin_table_work_experience').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/experience") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php $hidden = array('u_basic_info' => 'UPDATE');?>
<?php echo form_open('hrms/admin/employees/e_bank_account_info', $attributes, $hidden);?>
<?php
$edata_usr7 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_bank_account = $('#xin_table_bank_account').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/bank_account") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php $hidden = array('u_basic_info' => 'UPDATE');?>
<?php echo form_open('hrms/admin/employees/e_security_level_info', $attributes, $hidden);?>
<?php
$edata_usr7 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var exin_table_security_level = $('#xin_table_security_level').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/security_level_list") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php $hidden = array('u_basic_info' => 'UPDATE');?>
<?php echo form_open('hrms/admin/employees/e_contract_info', $attributes, $hidden);?>
<?php
$edata_usr7 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_contract = $('#xin_table_contract').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/contract") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php $hidden = array('u_basic_info' => 'UPDATE');?>
<?php echo form_open('hrms/admin/employees/e_leave_info', $attributes, $hidden);?>
<?php
$edata_usr7 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_leave = $('#xin_table_leave').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/leave") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php $hidden = array('u_basic_info' => 'UPDATE');?>
<?php echo form_open('hrms/admin/employees/e_shift_info', $attributes, $hidden);?>
<?php
$edata_usr7 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_shift = $('#xin_table_shift').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/shift") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php $hidden = array('u_basic_info' => 'UPDATE');?>
<?php echo form_open('hrms/admin/employees/e_location_info', $attributes, $hidden);?>
<?php
$edata_usr7 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_location = $('#xin_table_location').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/location") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php $hidden = array('u_basic_info' => 'UPDATE');?>
<?php echo form_open('hrms/admin/employees/update_allowance_info', $attributes, $hidden);?>
<?php
$edata_usr7 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_all_allowances = $('#xin_table_all_allowances').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/salary_all_allowances") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php $hidden = array('u_basic_info' => 'UPDATE');?>
<?php echo form_open('hrms/admin/employees/update_loan_info', $attributes, $hidden);?>
<?php
$edata_usr7 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_all_deductions = $('#xin_table_all_deductions').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/salary_all_deductions").'/'.$employee_id; ?>/",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php $hidden = array('u_basic_info' => 'UPDATE');?>
<?php echo form_open('hrms/admin/employees/update_overtime_info', $attributes, $hidden);?>
<?php
$edata_usr7 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_emp_overtime = $('#xin_table_emp_overtime').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/salary_overtime") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php $hidden = array('u_basic_info' => 'UPDATE');?>
<?php echo form_open('hrms/admin/employees/update_commissions_info', $attributes, $hidden);?>
<?php
$edata_usr7 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_all_commissions = $('#xin_table_all_commissions').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/salary_all_commissions") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php $hidden = array('u_basic_info' => 'UPDATE');?>
<?php echo form_open('hrms/admin/employees/update_statutory_deductions_info', $attributes, $hidden);?>
<?php
$edata_usr7 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_all_statutory_deductions = $('#xin_table_all_statutory_deductions').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/salary_all_statutory_deductions") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php $hidden = array('u_basic_info' => 'UPDATE');?>
<?php echo form_open('hrms/admin/employees/update_other_payment_info', $attributes, $hidden);?>
<?php
$edata_usr7 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_all_other_payments = $('#xin_table_all_other_payments').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/employees/salary_all_other_payments") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
