...
<?php echo form_open_multipart('hrms/admin/announcement/update/'.$announcement_id, $attributes, $hidden);?>
			...
			success: function(JSON)
			{
				if (JSON.error != '') {
					...
					var xin_table = $('#xin_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("hrms/admin/announcement/announcement_list") ?>",
							type : 'GET'
						},
  ...
  <div class="table-responsive" data-pattern="priority-columns">
    ...
    <?php foreach($module_attributes as $mattribute):?>
      ...
      <tr>
          ...
          <img src="<?php echo base_url().'uploads/custom_files/'.$attr_val;?>" width="70px" id="u_file">&nbsp; <a href="<?php echo site_url('hrms/admin/download');?>?type=custom_files&filename=<?php echo $attr_val;?>"><?php echo $this->lang->line('xin_download');?></a>
          <?php } ?></td>
      </tr>
      <?php } else { ?>
      <tr>
