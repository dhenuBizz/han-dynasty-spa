...
<?php echo form_open('hrms/admin/termination/update/'.$termination_id, $attributes, $hidden);?>
		...
		$.ajax({
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					"bDestroy": true,
					"ajax": {
						url : "<?php echo site_url("hrms/admin/termination/termination_list") ?>",
						type : 'GET'
					},
					dom: 'lBfrtip',
    ...
    <table class="footable-details table table-striped table-hover toggle-circle">
      <tbody>
        ...
        <td style="display: table-cell;"><?php if($attachment!='' && $attachment!='no file') {?>
          <img src="<?php echo base_url().'uploads/termination/'.$attachment;?>" width="70px" id="u_file">&nbsp; <a href="<?php echo site_url()?>hrms/admin/download?type=termination&filename=<?php echo $attachment;?>"><?php echo $this->lang->line('xin_download');?></a>
          <?php } ?></td>
      </tr>
        <tr>
