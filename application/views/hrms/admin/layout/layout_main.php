...
?>
<?php $this->load->view('hrms/admin/components/htmlheader');?>
...
<div class="wrapper"> 
<?php $this->load->view('hrms/admin/components/header');?>

  <!-- Left side column. contains the logo and sidebar -->
  <aside class="main-sidebar">
    <!-- sidebar: style can be found in sidebar.less -->
    <?php $this->load->view('hrms/admin/components/left_menu');?>
    <!-- /.sidebar -->
    <div class="sidebar-footer">
		<?php  if(in_array('60',$role_resources_ids)) { ?>
        <!-- item-->
		<a href="<?php echo site_url('hrms/admin/settings');?>" class="link" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('header_configuration');?>"><i class="fa fa-cog fa-spin"></i></a>
        <?php } else {?>
        <a href="<?php echo site_url('hrms/admin/dashboard');?>" class="link" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('dashboard_title');?>"><i class="fa fa-dashboard"></i></a>
        <?php } ?>
		<!-- item-->
		<a href="<?php echo site_url('hrms/admin/profile');?>" class="link" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('header_my_profile');?>"><i class="fa fa-user"></i></a>
		<!-- item-->
		<a href="<?php echo site_url('hrms/admin/logout');?>" class="link" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('header_sign_out');?>"><i class="fa fa-power-off"></i></a>
	</div>
  </aside>
  ...
  <?php } ?>
    ...
    #hrload-img {
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('hrms/admin/theme/');?>"><i class="fa fa-columns"></i> <?php echo $this->lang->line('xin_theme_settings');?></a></li>
        <li><a href="<?php echo site_url('hrms/admin/settings/');?>"><i class="fa fa-cog"></i> <?php echo $this->lang->line('header_configuration');?></a></li>
      </ol>
      <?php endif;?>
    </section>
    <?php } ?>
  ...
  <!-- /.content-wrapper -->
  <?php $this->load->view('hrms/admin/components/footer');?>
...
<!-- Layout footer -->
<?php $this->load->view('hrms/admin/components/htmlfooter');?>
<!-- / Layout footer -->
</body>
</html>