  ...
  <div class="row match-heights <?php echo $get_animate?>">
    ...
    <div class="col-md-10 current-tab animated fadeInRight" id="import_employees">
      ...
      <div class="box-body">
        ...
        <?php echo form_open_multipart('hrms/admin/import/import_employees', $attributes, $hidden);?>
        <div class="row">
          <div class="col-md-4">
    ...
    <div class="col-md-10 current-tab animated fadeInRight" id="import_attendance" style="display:none;">
      <div class="box">
          ...
          <div class="box-body">
            ...
            <?php $hidden = array('user_id' => $session['user_id']);?>
            <?php echo form_open_multipart('hrms/admin/import/import_attendance', $attributes, $hidden);?>
            <fieldset class="form-group">
    ...
    <div class="col-md-10 current-tab animated fadeInRight" id="import_leads" style="display:none;">
      <div class="box <?php echo $get_animate;?>">
          ...
          <div class="box-body">
            ...
            <?php $hidden = array('user_id' => $session['user_id']);?>
            <?php echo form_open_multipart('hrms/admin/leads/import_leads', $attributes, $hidden);?>
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <fieldset class="form-group">
