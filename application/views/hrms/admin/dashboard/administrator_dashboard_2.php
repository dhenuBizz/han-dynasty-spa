...
<div class="row <?php echo $get_animate;?>">
  <div class="col-xl-3 col-md-3">
    <div class="card mini-stat bg-primary" style="background-color: #47253f !important">
      <div class="card-body mini-stat-img">
        ...
        <div class="text-white">
          ...
          <h4 class="mb-4"><a class="text-card-muted" href="<?php echo site_url('hrms/admin/employees');?>"><?php echo $this->Employees_model->get_total_employees();?></a></h4>
  ...
  <div class="col-xl-3 col-md-3">
    <div class="card mini-stat bg-green" style="background-color: #77575d !important">
      <div class="card-body mini-stat-img">
        ...
        <div class="text-white">
          ...
          <a class="text-card-muted" href="<?php echo site_url('hrms/admin/roles');?>"><?php echo $this->lang->line('left_set_roles');?></a> </div>
      </div>
    </div>
  </div>
  <div class="col-xl-3 col-md-3">
    <div class="card mini-stat bg-purple" style="background-color: #47253f !important">
      <div class="card-body mini-stat-img">
        ...
        <div class="text-white">
          ...
          <a class="text-card-muted" href="<?php echo site_url('hrms/admin/timesheet/leave');?>"><?php echo $this->lang->line('xin_hr_view_applications');?></a> </div>
      </div>
    </div>
  </div>
  <div class="col-xl-3 col-md-3">
    <div class="card mini-stat bg-red" style="background-color: #77575d !important">
      <div class="card-body mini-stat-img">
        ...
        <div class="text-white">
          ...
          <a class="text-card-muted" href="<?php echo site_url('hrms/admin/settings');?>"><?php echo $this->lang->line('header_configuration');?></a> </div>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="card mini-stat bg-yellow">
      <div class="card-body mini-stat-img">
        ...
        <div class="text-white">
          ...
          <h4 class="mb-4"><?php echo $this->lang->line('xin_performance_management');?></h4>
          <a class="text-card-muted" href="<?php echo site_url('hrms/admin/files');?>"><?php echo $this->lang->line('xin_hr_upload_documents');?></a> </div>
      </div>
    </div>
  </div>
  <?php } else {?>
    ...
    <div class="card mini-stat bg-yellow">
      <div class="card-body mini-stat-img">
        ...
        <div class="text-white">
          ...
          <a class="text-card-muted" href="<?php echo site_url('hrms/admin/timesheet/holidays');?>"><?php echo $this->lang->line('xin_view');?></a> </div>
      </div>
    </div>
  </div>
  <?php } ?>
    ...
    <div class="card mini-stat bg-red">
      <div class="card-body mini-stat-img">
        ...
        <div class="text-white">
          ...
          <h4 class="mb-4"><?php echo $this->lang->line('left_settings');?></h4>
          <a class="text-card-muted" href="<?php echo site_url('hrms/admin/theme');?>"><?php echo $this->lang->line('header_configuration');?></a> </div>
      </div>
    </div>
  </div>
    ...
    <div class="card mini-stat bg-aqua">
      <div class="card-body mini-stat-img">
        ...
        <div class="text-white">
          ...
          <h4 class="mb-4"><a class="text-card-muted" href="<?php echo site_url('hrms/admin/project');?>"><?php echo $this->Xin_model->get_all_projects();?></a></h4>
    ...
    <div class="card mini-stat bg-green">
      <div class="card-body mini-stat-img">
        ...
        <div class="text-white">
          ...
          <h4 class="mb-4"><a class="text-card-muted" href="<?php echo site_url('hrms/admin/timesheet/tasks');?>"><?php echo $this->Xin_model->get_all_tasks();?></a></h4>
    ...
    <div class="card mini-stat bg-aqua">
      <div class="card-body mini-stat-img">
        ...
        <div class="text-white">
          ...
          <a class="text-card-muted" href="<?php echo site_url('hrms/admin/settings/modules');?>"><?php echo $this->lang->line('xin_setup_modules');?></a> </div>
      </div>
    </div>
  </div>
  <div class="col-xl-3 col-md-3">
    <div class="card mini-stat bg-green">
      <div class="card-body mini-stat-img">
        ...
        <div class="text-white">
          ...
          <a class="text-card-muted" href="<?php echo site_url('hrms/admin/timesheet/office_shift');?>"><?php echo $this->lang->line('xin_view');?></a> </div>
      </div>
    </div>
  </div>
  <?php } ?>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
					...
					?>
                    <h3 class="text-info fw-bold"><a class="text-card-mduted" href="<?php echo site_url('hrms/admin/project');?>"><?php echo $this->Xin_model->get_all_projects();?></a></h3>
                </div>
                <div class="progress progress-sm">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    ?>
                    <h3 class="text-info fw-bold"><a class="text-card-mduted" href="<?php echo site_url('hrms/admin/timesheet/tasks');?>"><?php echo $this->Xin_model->get_all_tasks();?></a></h3>
                </div>
                <div class="progress progress-sm">
