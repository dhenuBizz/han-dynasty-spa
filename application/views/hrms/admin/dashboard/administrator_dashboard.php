...
<div class="row <?php echo $get_animate;?>">
  <div class="col-xl-6 col-md-3 col-12 hr-mini-state">
    <a class="text-muted" href="<?php echo site_url('hrms/admin/employees');?>">
  ...
  <!-- /.col -->
  <div class="col-xl-6 col-md-3 col-12 hr-mini-state">
    <a class="text-muted" href="<?php echo site_url('hrms/admin/roles');?>">
  ...
  <div class="col-xl-6 col-md-3 col-12 hr-mini-state">
    <a class="text-muted" href="<?php echo site_url('hrms/admin/timesheet/leave');?>"> 
  ...
  <!-- /.col -->
  <div class="col-xl-6 col-md-3 col-12 hr-mini-state">
    <a class="text-muted" href="<?php echo site_url('hrms/admin/settings');?>"> 
...
<div class="row <?php echo $get_animate;?>">
  ...
  <div class="col-xl-3 col-md-3 col-12 hr-mini-state">
    <a class="text-muted" href="<?php echo site_url('hrms/admin/files');?>"> 
  ...
  <?php } else {?>
  <div class="col-xl-3 col-md-3 col-12 hr-mini-state">
    <a class="text-muted" href="<?php echo site_url('hrms/admin/timesheet/holidays');?>"> 
  ...
  <?php } ?>
  <div class="col-xl-3 col-md-3 col-12 hr-mini-state">
    <a class="text-muted" href="<?php echo site_url('hrms/admin/theme');?>"> 
  ...
  <div class="col-xl-3 col-md-3 col-12 hr-mini-state">
    <a class="text-muted" href="<?php echo site_url('hrms/admin/project');?>">
    ...
    <div class="col-xl-3 col-md-3 col-12 hr-mini-state">
    <a class="text-muted" href="<?php echo site_url('hrms/admin/timesheet/tasks');?>">
  ...
  <?php } else {?>
  <div class="col-xl-3 col-md-3 col-12 hr-mini-state">
    <a class="text-muted" href="<?php echo site_url('hrms/admin/designation');?>"> 
    ...
    <div class="col-xl-3 col-md-3 col-12 hr-mini-state">
    <a class="text-muted" href="<?php echo site_url('hrms/admin/timesheet/office_shift');?>"> 
...
<div class="row <?php echo $get_animate;?>">
  <div class="col-md-4 col-12">
    <div class="box box-body hr-mini-state hrsalle-mini-stat">
      <a class="text-card-muted" href="<?php echo site_url('hrms/admin/tickets');?>"><div class="flexbox"> <span class="fa fa-ticket text-primary font-size-50"></span> <span class="font-size-40 font-weight-400"><?php echo total_tickets();?></span> </div>
      <div class="text-right"><?php echo $this->lang->line('xin_hr_total_tickets');?></div></a>
    </div>
  </div>
  <div class="col-md-4 col-12">
    <div class="box box-body hr-mini-state hrsalle-mini-stat">
      <a class="text-card-muted" href="<?php echo site_url('hrms/admin/tickets');?>"><div class="flexbox"> <span class="fa fa-server text-danger font-size-50"></span> <span class="font-size-40 font-weight-400"><?php echo total_open_tickets();?></span> </div>
      <div class="text-right"><?php echo $this->lang->line('xin_hr_total_open_tickets');?></div></a>
    </div>
  </div>
  <div class="col-md-4 col-12">
    <div class="box box-body hr-mini-state hrsalle-mini-stat">
      <a class="text-card-muted" href="<?php echo site_url('hrms/admin/tickets');?>"><div class="flexbox"> <span class="ion ion-thumbsup text-success font-size-50"></span> <span class="font-size-40 font-weight-400"><?php echo total_closed_tickets();?></span> </div>
...
$abs = $total - $working;
?>
<?php $this->load->view('hrms/admin/calendar/calendar_hr');?>
<div class="row <?php echo $get_animate;?>">
  <div class="col-md-3">
    <div class="row">
      ...
      <div class="col-md-12 col-12 hr-mini-state">
        <div class="box box-body hrsalle-mini-stat">
          <a class="text-card-muted" href="<?php echo site_url('hrms/admin/expense');?>"><div class="flexbox"> <span class="fa fa-money text-red font-size-50"></span> <span class="font-size-40 font-weight-400"><?php echo $this->Xin_model->currency_sign($exp_am[0]->exp_amount);?></span> </div>
      ...
      <div class="col-md-12 col-12 hr-mini-state">
        <div class="box box-body hrsalle-mini-stat">
          <a class="text-card-muted" href="<?php echo site_url('hrms/admin/payroll/payment_history');?>"><div class="flexbox"> <span class="fa fa-dollar text-primary font-size-50"></span> <span class="font-size-40 font-weight-400"><?php echo $this->Xin_model->currency_sign($all_sal);?></span> </div>
          ...
          <div class="box-body" style="">
            <ul class="products-list product-list-in-box">
              ...
              <li class="item">
                ...
                <div class="product-info"> <a href="<?php echo site_url();?>hrms/admin/employees/detail/<?php echo $employee->user_id;?>" class="product-title"><?php echo $fname;?></a> <span class="product-description"> <?php echo $department_designation;?> </span> </div>
              </li>
              <?php } ?>
            </ul>
          </div>
  ...
  <div class="col-sm-6 col-xl-6 col-md-6">
    <div class="box">
      ...
      <div class="box-body">
        <div class="table-responsive">
          <table class="table no-margin table-striped">
            ...
            ?>
              <tr>
                <td><a target="_blank" href="<?php echo site_url().'hrms/admin/employees/detail/'.$last_payments->employee_id;?>/"><?php echo $full_name;?></a></td>
                <td><?php echo $p_amount;?></td>
                <td><?php echo $month_payment;?></td>
                <td><a target="_blank" href="<?php echo site_url().'hrms/admin/payroll/payslip/id/'.$last_payments->payslip_id;?>/"><?php echo $this->lang->line('xin_payslip');?></a></td>
              </tr>
              <?php } ?>
              <?php endforeach;?>
            </tbody>
      ...
      <!-- /.box-body -->
      <div class="box-footer clearfix"> <a href="<?php echo site_url('hrms/admin/payroll/payment_history');?>" target="_blank" class="btn btn-sm btn-default btn-flat pull-right"><?php echo $this->lang->line('xin_all_payslips');?></a> </div>
      <!-- /.box-footer --> 
    </div>
  </div>
  <div class="col-md-6 col-sm-6 col-xs-12">
    <div class="info-box"> <span class="info-box-icon info-box-icon-hrsale"><i class="fa fa-university text-green"></i></span>
      <div class="info-box-content info-box-content-hrsale"> <span class="info-box-text"><?php echo $this->lang->line('xin_acc_account_balances');?> <span class="pull-right text-green dashboard-text"><?php echo $this->Xin_model->currency_sign(total_account_balances());?></span></span> <span class="info-box-number"><a class="text-muted" href="<?php echo site_url('hrms/admin/accounting/bank_cash');?>"> <?php echo $this->lang->line('xin_view');?> <i class="fa fa-arrow-right"></i></a></span> </div>
      <!-- /.info-box-content --> 
    </div>
    <!-- /.info-box --> 
  </div>
