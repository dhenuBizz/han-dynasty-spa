    ...
    <div class="card hrsale-box-three hrsale-dash-purple">
        <div class="card-body">
            ...
            <div class="hrsale-box-three-content">
                ...
                <h3 class="text-white"><span data-plugin="counterup"><a class="text-white" href="<?php echo site_url('hrms/admin/employees');?>"><?php echo $this->Employees_model->get_total_employees();?></a></span> <small><i class="mdi mdi-arrow-up text-white"></i></small></h3>
    ...
    <div class="card hrsale-box-three hrsale-dash-info">
        <div class="card-body">
            ...
            <div class="hrsale-box-three-content">
                ...
                <p class="text-white m-0"><a class="text-white" href="<?php echo site_url('hrms/admin/roles');?>"><?php echo $this->lang->line('left_set_roles');?></a></p>
            </div>
        </div>
    </div>
</div><!-- end col -->
    ...
    <div class="card hrsale-box-three hrsale-dash-pink">
        <div class="card-body">
            ...
            <div class="hrsale-box-three-content">
                ...
                <p class="text-white m-0"><a class="text-white" href="<?php echo site_url('hrms/admin/timesheet/leave');?>"><?php echo $this->lang->line('xin_hr_view_applications');?></a></p>
            </div>
        </div>
    </div>
</div><!-- end col -->
    ...
    <div class="card hrsale-box-three hrsale-dash-success">
        <div class="card-body">
            ...
            <div class="hrsale-box-three-content">
                ...
                <p class="text-white m-0"><a class="text-white" href="<?php echo site_url('hrms/admin/settings');?>"><?php echo $this->lang->line('header_configuration');?></a></p>
            </div>
        </div>
    </div>
</div><!-- end col -->
    ...
    <div class="card hrsale-box-three hrsale-dash-warning">
        <div class="card-body">
            ...
            <div class="hrsale-box-three-content">
                ...
                <p class="text-white m-0"><a class="text-white" href="<?php echo site_url('hrms/admin/files');?>"><?php echo $this->lang->line('xin_hr_upload_documents');?></a></p>
            </div>
        </div>
    </div>
</div><!-- end col -->
    ...
    <div class="card hrsale-box-three hrsale-dash-warning">
        <div class="card-body">
            ...
            <div class="hrsale-box-three-content">
                ...
                <p class="text-white m-0"><a class="text-white" href="<?php echo site_url('hrms/admin/timesheet/holidays');?>"><?php echo $this->lang->line('xin_view');?></a></p>
            </div>
        </div>
    </div>
</div><!-- end col -->
    ...
    <div class="card hrsale-box-three hrsale-dash-danger">
        <div class="card-body">
            ...
            <div class="hrsale-box-three-content">
                ...
                <h3 class="text-white"><span data-plugin="counterup"><?php echo $this->lang->line('left_settings');?></span> <small><i class="mdi mdi-arrow-up text-white"></i></small></h3>
                <p class="text-white m-0"><a class="text-white" href="<?php echo site_url('hrms/admin/theme');?>"><?php echo $this->lang->line('header_configuration');?></a></p>
            </div>
        </div>
    </div>
</div><!-- end col -->
    ...
    <div class="card hrsale-box-three hrsale-dash-primary">
        <div class="card-body">
            ...
            <div class="hrsale-box-three-content">
                ...
                <h3 class="text-white"><span data-plugin="counterup"><a class="text-white" href="<?php echo site_url('hrms/admin/project');?>"><?php echo $this->lang->line('project');?> <?php echo $this->Xin_model->get_all_projects();?></a></span> <small><i class="mdi mdi-arrow-up text-white"></i></small></h3>
    ...
    <div class="card hrsale-box-three hrsale-dash-inverse">
        <div class="card-body">
            ...
            <div class="hrsale-box-three-content">
                ...
                <h3 class="text-white"><span data-plugin="counterup"><a class="text-white" href="<?php echo site_url('hrms/admin/timesheet/tasks');?>"><?php echo $this->Xin_model->get_all_tasks();?></a></span> <small><i class="mdi mdi-arrow-up text-white"></i></small></h3>
    ...
    <div class="card hrsale-box-three hrsale-dash-primary">
        <div class="card-body">
            ...
            <div class="hrsale-box-three-content">
                ...
                <p class="text-white m-0"><a class="text-white" href="<?php echo site_url('hrms/admin/settings/modules');?>"><?php echo $this->lang->line('xin_setup_modules');?></a></p>
            </div>
        </div>
    </div>
</div><!-- end col -->
    ...
    <div class="card hrsale-box-three hrsale-dash-inverse">
        <div class="card-body">
            ...
            <div class="hrsale-box-three-content">
                ...
                <p class="text-white m-0"><a class="text-white" href="<?php echo site_url('hrms/admin/timesheet/office_shift');?>"><?php echo $this->lang->line('xin_view');?></a></p>
            </div>
        </div>
    </div>
</div><!-- end col -->
...
<div class="row">
  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
    <div class="info-box"> <span class="info-box-icon info-box-icon-hrsale"><i class="fa fa-money text-red"></i></span>
      <div class="info-box-content info-box-content-hrsale"> <span class="info-box-text"><?php echo $this->lang->line('dashboard_total_expenses');?> <span class="pull-right text-green dashboard-text"><?php echo $this->Xin_model->currency_sign($exp_am[0]->exp_amount);?></span></span> <span class="info-box-number"><a class="text-muted" href="<?php echo site_url('hrms/admin/expense');?>"> <?php echo $this->lang->line('xin_view');?> <i class="fa fa-arrow-right"></i></a></span> </div>
      <!-- /.info-box-content --> 
    </div>
    <!-- /.info-box --> 
  </div>
  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
    <div class="info-box"> <span class="info-box-icon info-box-icon-hrsale"><i class="fa fa-dollar text-red"></i></span>
      <div class="info-box-content info-box-content-hrsale"> <span class="info-box-text"><?php echo $this->lang->line('dashboard_total_salaries');?> <span class="pull-right text-green dashboard-text"><?php echo $this->Xin_model->currency_sign($all_sal);?></span></span> <span class="info-box-number"><a class="text-muted" href="<?php echo site_url('hrms/admin/payroll/payment_history');?>"> <?php echo $this->lang->line('xin_view');?> <i class="fa fa-arrow-right"></i></a></span> </div>
      <!-- /.info-box-content --> 
    </div>
    <!-- /.info-box --> 
  </div>
