...
<?php if(in_array('14',$role_resources_ids)) { ?>
  ...
  <div class="col-xl-6 col-md-3 col-12 hr-mini-state"> <a class="text-muted" href="<?php echo site_url('hrms/admin/awards/');?>">
  ...
  <?php } else {?>
  <div class="col-xl-6 col-md-3 col-12 hr-mini-state"> <a class="text-muted" href="<?php echo site_url('hrms/admin/timesheet/attendance/');?>">
  ...
  <!-- /.col -->
  <div class="col-xl-6 col-md-3 col-12 hr-mini-state"> <a class="text-muted" href="<?php echo site_url('hrms/admin/payroll/payment_history/');?>">
  ...
  <div class="col-xl-6 col-md-3 col-12 hr-mini-state"> <a class="text-muted" href="<?php echo site_url('hrms/admin/timesheet/leave/');?>">
  ...
  <div class="col-xl-6 col-md-3 col-12 hr-mini-state"> <a class="text-muted" href="<?php echo site_url('hrms/admin/travel/');?>">
            ...
            <div class="box-footer">
                ...
                <div class="col-sm-12">
                  <div class="text-xs-center">
                    <div class="text-xs-center pb-0-5">
                      ...
                      <?php echo form_open('hrms/admin/timesheet/set_clocking', $attributes, $hidden);?>
              ...
              <div class="row">
                <div class="col-md-12 col-md-offset-1">
                  <div class="margin">
                    <div class="btn-group"> <a type="button" href="<?php echo site_url('hrms/admin/timesheet/');?>" class="btn btn-default btn-flat">My Attendance Timesheet</a> </div>
                  </div>
                </div>
              </div>
              <?php } ?>
              ...
              <div class="table-responsive" data-pattern="priority-columns">
                <table class="table table-striped m-md-b-0">
                  <tbody>
                    ...
                    <tr>
                      <th scope="row" colspan="2" style="text-align: center;"><a href="<?php echo site_url('hrms/admin/timesheet/timecalendar/');?>"><?php echo $this->lang->line('xin_attendance_cal_view');?></a></th>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
              ...
              <?php $dId = array(); $i=1; $ct_tasks = 0;
				$ovt_tasks = 0; $tot_tasks=0; foreach($task->result() as $et):
				 ...
				 foreach($aim as $dIds) {
					...
					?>
              <tr>
                <td><?php echo '<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_view_details').'"><a href="'.site_url().'hrms/admin/timesheet/task_details/id/'.$et->task_id.'/"><button type="button" class="btn btn-secondary btn-sm m-b-0-0 waves-effect waves-light"><i class="fa fa-arrow-circle-right"></i></button></a></span>';?></td>
                <td class="text-truncate"><?php echo $task_catname;?><br />
                  <a href="<?php echo site_url();?>hrms/admin/project/detail/<?php echo $et->project_id;?>/"><?php echo $prj_name;?></a></td>
    ...
    <div class="box">
      ...
      <div class="box-body px-1">
        <div id="recent-buyers" class="list-group scrollable-container height-350 position-relative">
		  ...
		  ?>
          <a href="<?php echo site_url('hrms/jobs/detail/').$job->job_url;?>" class="list-group-item list-group-item-action media no-border">
...
<div class="row match-height">
  ...
  <div class="col-xl-8 col-lg-8">
    <div class="box">
      ...
      <div class="box-body">
        <div class="box-block">
          <p><?php echo $this->lang->line('xin_my_assigned_projects');?> <span class="float-xs-right"><a href="<?php echo site_url('hrms/admin/project');?>"><?php echo $this->lang->line('xin_more_projects');?> <i class="ft-arrow-right"></i></a></span></p>
        </div>
          ...
          <table id="recent-orderss" class="table table-hover mb-0 ps-container ps-theme-default">
            ...
            <tbody>
			 ...
			 foreach($aim as $dIds) {
				...
				?>
              <tr>
                <td class="text-truncate"><a href="<?php echo site_url();?>hrms/admin/project/detail/<?php echo $pj->project_id;?>/"><?php echo $pj->title;?></a></td>
    ...
    <div class="box">
      ...
      <div class="box-body px-1">
        <div id="recent-buyers" class="list-group scrollable-container height-300 position-relative">
		  ...
		  ?>
          <a target="_blank" href="<?php echo site_url('hrms/jobs/detail/').$job->job_url;?>" class="list-group-item list-group-item-action media no-border">
          <div class="media-body">
            <h6 class="list-group-item-heading"><?php echo $job->job_title;?> <span class="float-xs-right pt-1"><span class="tag tag-warning ml-1"><?php echo $jt_type;?></span></span></h6>
          </div>
          </a>
