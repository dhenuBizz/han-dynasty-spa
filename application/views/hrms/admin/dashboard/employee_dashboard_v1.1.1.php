    ...
    <div class="d-flex col-md-8 align-items-stretch">
         <?php if($system[0]->module_awards=='true'){?>
             ...
             <div class="col-md-4 col-sm-6 col-xs-12 box-footer text-black">
              <div class="clearfix">
                <span class="pull-left"><i class="fa fa-trophy text-light-blue dasboard-icon"></i> <span class="hrsale-font-dash"><a href="<?php echo site_url('hrms/admin/awards');?>"><?php echo $this->Exin_model->total_employee_awards_dash();?> <?php echo $this->lang->line('left_awards');?></a></span></span>
              </div>
            </div>
            <?php } ?>
        <?php } else {?>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 box-footer text-black">
          <div class="clearfix">
            <span class="pull-left"><i class="fa fa-calendar-check-o text-light-blue dasboard-icon"></i> <span class="hrsale-font-dash"><a href="<?php echo site_url('hrms/admin/timesheet/attendance');?>"><?php echo $this->lang->line('xin_view');?> <?php echo $this->lang->line('dashboard_attendance');?></a></span></span>
          </div>
        </div>
        <?php } ?>
        <?php } ?>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 box-footer text-black">
          <div class="clearfix">
            <span class="pull-left"><i class="fa fa-dollar text-light-blue dasboard-icon"></i> <span class="hrsale-font-dash"><a href="<?php echo site_url('hrms/admin/expense');?>">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 box-footer">
          <div class="clearfix">
            <span class="pull-left"><i class="fa fa-tags text-light-blue dasboard-icon"></i> <span class="hrsale-font-dash"><a href="<?php echo site_url('hrms/admin/tickets');?>"><?php echo $this->lang->line('xin_view');?> <?php echo $this->lang->line('left_tickets');?></a></span></span>
          </div>
        </div>
        <?php } ?>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 box-footer text-black">
          <div class="clearfix">
            <span class="pull-left"><i class="fa fa-calendar text-light-blue dasboard-icon"></i> <span class="hrsale-font-dash"><a href="<?php echo site_url('hrms/admin/timesheet/leave');?>"><?php echo $this->lang->line('left_leave');?> <?php echo $this->lang->line('xin_performance_management');?></a></span></span>
          </div>
        </div>
        <?php } ?>
        <?php if($system[0]->module_travel=='true'){?>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 box-footer">
              <div class="clearfix">
                <span class="pull-left"><i class="fa fa-plane text-light-blue dasboard-icon"></i> <span class="hrsale-font-dash"><a href="<?php echo site_url('hrms/admin/travel');?>"><?php echo $this->lang->line('xin_travel');?> <?php echo $this->lang->line('xin_requests');?></a></span></span>
              </div>
            </div>
            <?php } ?>
        <?php } ?>
     ...
     foreach($aim as $dIds) {
      ...
      <div class="card pb-4 mb-2 hrsale-dash-prj">
        <div class="row no-gutters align-items-center">
          <div class="col-12 col-md-4 px-4 pt-4"> <a href="<?php echo site_url();?>hrms/admin/project/detail/<?php echo $pj->project_id;?>/" class="text-dark-hr font-weight-semibold"><?php echo $pj->title;?></a> <br>
    ...
    <div class="card mb-4">
      <ul id="tasks-scrollbar" class="list-group list-group-flush ps ps--active-y" style="height: 300px">
        ...
        <li class="list-group-item employee-list-tasks py-3">
          ...
          <div class="font-weight-semibold"> <a href="<?php echo site_url('hrms/admin/timesheet/task_details/id/').$et->task_id.'/';?>"> <?php echo $et->task_name;?></a></div>
