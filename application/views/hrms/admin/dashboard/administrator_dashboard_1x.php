    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1"><b><a href="<?php echo site_url('hrms/admin/employees');?>"><?php echo $this->Employees_model->get_total_employees();?> <small><?php echo $this->lang->line('xin_people');?></small></a></b></h5>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1"><b><a href="<?php echo site_url('hrms/admin/roles');?>"> <?php echo $this->lang->line('xin_roles');?> <small><?php echo $this->lang->line('xin_permission');?></small></a></b></h5>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1"><b><a href="<?php echo site_url('hrms/admin/timesheet/leave');?>"> <?php echo $this->lang->line('left_leave');?> <small><?php echo $this->lang->line('xin_performance_management');?></small></a></b></h5>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1"><b><a href="<?php echo site_url('hrms/admin/settings');?>"> <?php echo $this->lang->line('xin_configure_hr');?> <small><?php echo $this->lang->line('left_settings');?></small></a></b></h5>
