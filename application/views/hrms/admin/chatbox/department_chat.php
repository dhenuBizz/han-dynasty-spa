	...
	?>
      ...
      <section class="chat-app-form">
         <div class="box-footer">
              ...
              <?php echo form_open('hrms/admin/chat/send_department_chat/', $attributes, $hidden);?>
...
var first_run = 0;
	function mrefreshMessages() {
		...
		if(rfromId!='' && rtoId!='') {
		  ...
		  $.ajax({
			url: "<?php echo site_url('hrms/admin/chat/refresh_department_chatbox');?>?from_id=<?php echo $fid;?>&department_id=<?php echo $chat_group_department_id;?>",
			type: 'GET',
			dataType: 'html',
	  ...
	  $("#xin-department-form").submit(function(e){
		...
		$.ajax({
			...
			success: function(JSON)
			{
				...
				var siteUrl = "<?php echo site_url('hrms/admin/chat/refresh_department_chatbox');?>?from_id=<?php echo $fid;?>&department_id=<?php echo $chat_group_department_id;?>";
