  ...
  <!--<div class="direct-chat-messages">-->
		  ...
		  foreach($this->Chat_model->get_messages() as $msgs){
            ...
            ?>
              ...
              <?php echo form_open('hrms/admin/chat/send_chat/', $attributes, $hidden);?>
...
var first_run = 0;
	function mrefreshMessages() {
		...
		if(rfromId!='' && rtoId!='') {
		  ...
		  $.ajax({
			url: "<?php echo site_url('hrms/admin/chat/refresh_chatbox');?>?from_id=<?php echo $fid;?>&to_id=<?php echo $tid; ?>",
			type: 'GET',
			dataType: 'html',
	  ...
	  $("#xin-form").submit(function(e){
		...
		$.ajax({
			...
			success: function(JSON)
			{
				...
				var siteUrl = "<?php echo site_url('hrms/admin/chat/refresh_chatbox');?>?from_id=<?php echo $fid;?>&to_id=<?php echo $tid; ?>";
