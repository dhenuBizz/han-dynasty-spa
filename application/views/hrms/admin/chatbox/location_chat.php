	...
	?>
      ...
      <section class="chat-app-form">
         <div class="box-footer">
              ...
              <?php echo form_open('hrms/admin/chat/send_location_chat/', $attributes, $hidden);?>
...
var first_run = 0;
	function mrefreshMessages() {
		...
		if(rfromId!='' && rtoId!='') {
		  ...
		  $.ajax({
			url: "<?php echo site_url('hrms/admin/chat/refresh_location_chatbox');?>?from_id=<?php echo $fid;?>&location_id=<?php echo $chat_group_location_id;?>",
			type: 'GET',
			dataType: 'html',
	  ...
	  $("#xin-location-form").submit(function(e){
		...
		$.ajax({
			...
			success: function(JSON)
			{
				...
				var siteUrl = "<?php echo site_url('hrms/admin/chat/refresh_location_chatbox');?>?from_id=<?php echo $fid;?>&location_id=<?php echo $chat_group_location_id;?>";
