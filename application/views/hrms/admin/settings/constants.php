      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php echo form_open('hrms/admin/settings/contract_type_info/', $attributes, $hidden);?>
      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php echo form_open('hrms/admin/settings/document_type_info/', $attributes, $hidden);?>
            <div class="form-group">
    ...
    <div class="row mb-4">
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">7570006456
            <?php $attributes = array('name' => 'edu_level_info', 'id' => 'edu_level_info', 'autocomplete' => 'off', 'class' => 'm-b-1 add');?>
            <?php $hidden = array('set_document_type' => 'UPDATE');?>
            <?php echo form_open('hrms/admin/settings/edu_level_info/', $attributes, $hidden);?>
            <div class="form-group">
      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php echo form_open('hrms/admin/settings/edu_language_info/', $attributes, $hidden);?>
            <div class="form-group">
      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php echo form_open('hrms/admin/settings/edu_skill_info/', $attributes, $hidden);?>
            <div class="form-group">
      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php echo form_open('hrms/admin/settings/award_type_info/', $attributes, $hidden);?>
            <div class="form-group">
      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php echo form_open('hrms/admin/settings/leave_type_info/', $attributes, $hidden);?>
            <div class="form-group">
      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php echo form_open('hrms/admin/settings/warning_type_info/', $attributes, $hidden);?>
            <div class="form-group">
      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php echo form_open('hrms/admin/settings/termination_type_info/', $attributes, $hidden);?>
            <div class="form-group">
      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php echo form_open('hrms/admin/settings/expense_type_info/', $attributes, $hidden);?>
            <div class="form-group">
      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php echo form_open('hrms/admin/settings/job_type_info/', $attributes, $hidden);?>
            <div class="form-group">
      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php $hidden = array('set_job_type' => 'UPDATE');?>
            <?php echo form_open('hrms/admin/settings/job_category_info/', $attributes, $hidden);?>
            <div class="form-group">
      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php echo form_open('hrms/admin/settings/exit_type_info/', $attributes, $hidden);?>
            <div class="form-group">
      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php echo form_open('hrms/admin/settings/travel_arr_type_info/', $attributes, $hidden);?>
            <div class="form-group">
      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php echo form_open('hrms/admin/settings/currency_type_info/', $attributes, $hidden);?>
            <div class="form-group">
      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php echo form_open('hrms/admin/settings/company_type_info/', $attributes, $hidden);?>
            <div class="form-group">
      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php echo form_open('hrms/admin/settings/ethnicity_type_info/', $attributes, $hidden);?>
            <div class="form-group">
      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php $hidden = array('set_ethnicity_type' => 'UPDATE');?>
            <?php echo form_open('hrms/admin/settings/income_type_info/', $attributes, $hidden);?>
            <div class="form-group">
      ...
      <div class="col-md-5">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php echo form_open('hrms/admin/settings/security_level_info/', $attributes, $hidden);?>
            <div class="form-group">
