...
<div class="row  <?php echo $get_animate;?>" style="margin-bottom:10px;">
  <div class="col-md-2">
    ...
    <?php echo form_open('hrms/admin/settings/delete_db_backup', $attributes, $hidden);?>
  ...
  <div class="col-md-3">
    ...
    <?php $hidden = array('user_id' => $session['user_id']);?>
    <?php echo form_open('hrms/admin/settings/create_database_backup', $attributes, $hidden);?>
