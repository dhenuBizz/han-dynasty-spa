...
<section id="basic-listgroup">
  ...
  <div class="col-lg-9 col-md-9 current-tab <?php echo $get_animate;?>" id="general"  style="display:none;">
    ...
    <?php echo form_open('hrms/admin/settings/company_info/'.$company_info_id, $attributes, $hidden);?>
    <div class="box">
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="box-block">
          ...
          <?php echo form_open('hrms/admin/settings/system_info/'.$company_info_id, $attributes, $hidden);?>
          <div class="bg-white">
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="box-block">
          ...
          <?php $hidden = array('u_basic_info' => 'UPDATE');?>
          <?php echo form_open('hrms/admin/settings/role_info/'.$company_info_id, $attributes, $hidden);?>
          <div class="bg-white">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="box-block">
          ...
          <?php $hidden = array('u_basic_info' => 'UPDATE');?>
          <?php echo form_open('hrms/admin/settings/payroll_config/'.$company_info_id, $attributes, $hidden);?>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="box-block">
          ...
          <?php $hidden = array('u_basic_info' => 'UPDATE');?>
          <?php echo form_open('hrms/admin/settings/job_info/'.$company_info_id, $attributes, $hidden);?>
          <div class="col-sm-12">
            <div class="form-group">
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="box-block">
          ...
          <?php $hidden = array('u_basic_info' => 'UPDATE');?>
          <?php echo form_open('hrms/admin/settings/email_info/'.$company_info_id, $attributes, $hidden);?>
          <div class="bg-white">
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="box-block">
          ...
          <?php $hidden = array('u_basic_info' => 'UPDATE');?>
          <?php echo form_open('hrms/admin/files/setting_info/'.$company_info_id, $attributes, $hidden);?>
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="box-block">
          ...
          <?php $hidden = array('u_basic_info' => 'UPDATE');?>
          <?php echo form_open('hrms/admin/settings/performance_info/'.$company_info_id, $attributes, $hidden);?>
          <div class="col-sm-12">
            <div class="form-group">
