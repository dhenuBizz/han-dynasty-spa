...
<div class="row match-heights">
  <div class="col-lg-8 col-md-8 current-tab <?php echo $get_animate;?>" id="general"  aria-expanded="false">
    ...
    <?php echo form_open('hrms/admin/settings/update_payment_gateway/996633', $attributes, $hidden);?>
    <div class="box">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <input class="form-control" placeholder="<?php echo $this->lang->line('xin_acc_paypal_ipn_url');?>" name="paypal_ipn_url" type="text" value="<?php echo site_url('hrms/admin/gateway/paypal_process/paypal_ipn');?>" readonly="readonly">
              </div>
            </div>
          </div>
