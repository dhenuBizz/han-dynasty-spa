...
<?php echo form_open('hrms/admin/settings/update_document_type/'.$row[0]->document_type_id, $attributes, $hidden);?>
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_document_type = $('#xin_table_document_type').dataTable({
						...
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/document_type_list") ?>",
							type : 'GET'
						},
...
<?php echo form_open('hrms/admin/settings/update_contract_type/'.$row[0]->contract_type_id, $attributes, $hidden);?>
<div class="modal-body">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_contract_type = $('#xin_table_contract_type').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/contract_type_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('hrms/admin/settings/update_payment_method/'.$row[0]->payment_method_id, $attributes, $hidden);?>
<div class="modal-body">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_payment_method = $('#xin_table_payment_method').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/payment_method_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('hrms/admin/settings/update_education_level/'.$row[0]->education_level_id, $attributes, $hidden);?>
<div class="modal-body">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_education_level = $('#xin_table_education_level').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/education_level_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('hrms/admin/settings/update_qualification_language/'.$row[0]->language_id, $attributes, $hidden);?>
<div class="modal-body">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_qualification_language = $('#xin_table_qualification_language').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/qualification_language_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('hrms/admin/settings/update_qualification_skill/'.$row[0]->skill_id, $attributes, $hidden);?>
<div class="modal-body">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_qualification_skill = $('#xin_table_qualification_skill').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/qualification_skill_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('hrms/admin/settings/update_award_type/'.$row[0]->award_type_id, $attributes, $hidden);?>
<div class="modal-body">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_award_type = $('#xin_table_award_type').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/award_type_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('hrms/admin/settings/update_leave_type/'.$row[0]->leave_type_id, $attributes, $hidden);?>
<div class="modal-body">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_leave_type = $('#xin_table_leave_type').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/leave_type_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('hrms/admin/settings/update_warning_type/'.$row[0]->warning_type_id, $attributes, $hidden);?>
<div class="modal-body">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_warning_type = $('#xin_table_warning_type').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/warning_type_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('hrms/admin/settings/update_termination_type/'.$row[0]->termination_type_id, $attributes, $hidden);?>
<div class="modal-body">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_termination_type = $('#xin_table_termination_type').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/termination_type_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('hrms/admin/settings/update_expense_type/'.$row[0]->expense_type_id, $attributes, $hidden);?>
<div class="modal-body">
  <div class="form-group">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_expense_type = $('#xin_table_expense_type').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/expense_type_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('hrms/admin/settings/update_job_type/'.$row[0]->job_type_id, $attributes, $hidden);?>
<div class="modal-body">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_job_type = $('#xin_table_job_type').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/job_type_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('hrms/admin/settings/update_job_category/'.$row[0]->category_id, $attributes, $hidden);?>
<div class="modal-body">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_job_category = $('#xin_table_job_category').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/job_category_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('hrms/admin/settings/update_exit_type/'.$row[0]->exit_type_id, $attributes, $hidden);?>
<div class="modal-body">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_exit_type = $('#xin_table_exit_type').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/exit_type_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('hrms/admin/settings/update_travel_arr_type/'.$row[0]->arrangement_type_id, $attributes, $hidden);?>
<div class="modal-body">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_travel_arr_type = $('#xin_table_travel_arr_type').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/travel_arr_type_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('hrms/admin/settings/update_currency_type/'.$row[0]->currency_id, $attributes, $hidden);?>
<div class="modal-body">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_currency_type = $('#xin_table_currency_type').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/currency_type_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('hrms/admin/settings/update_company_type/'.$row[0]->type_id, $attributes, $hidden);?>
<div class="modal-body">
  <div class="form-group">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_company_type = $('#xin_table_company_type').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/company_type_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php $hidden = array('_method' => 'EDIT', '_token' => $row[0]->type_id, 'ext_name' => $row[0]->name);?>
<?php echo form_open('hrms/admin/settings/update_security_level/'.$row[0]->type_id, $attributes, $hidden);?>
<div class="modal-body">
  <div class="form-group">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var exin_table_security_level = $('#xin_table_security_level').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/security_level_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('hrms/admin/employees/change_password/'.$row[0]->currency_id, $attributes, $hidden);?>
<div class="modal-body">
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
...
<?php echo form_open('hrms/admin/settings/update_ethnicity_type/'.$row[0]->ethnicity_type_id, $attributes, $hidden);?>
<div class="modal-body">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_ethnicity_type = $('#xin_table_ethnicity_type').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/ethnicity_type_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<?php echo form_open('hrms/admin/settings/update_income_type/'.$row[0]->category_id, $attributes, $hidden);?>
<div class="modal-body">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table_income_type = $('#xin_table_income_type').dataTable({
						...
						"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
						"ajax": {
							url : "<?php echo site_url("hrms/admin/settings/income_type_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
