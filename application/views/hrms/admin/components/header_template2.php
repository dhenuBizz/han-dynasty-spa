            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu <?php echo $animated;?>">
                  ...
                  <li role="presentation">
                    <a role="menuitem" tabindex="-1" target="_blank" href="<?php echo site_url();?>hrms/frontend/jobs/"><i class="fa fa-newspaper-o"></i><?php echo $this->lang->line('header_apply_jobs_frontend');?>
                    </a>
                  </li>
                  <?php  } ?>
                  <?php  } ?>
                  ...
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/employees/import');?>"> <i class="fa fa-users"></i><?php echo $this->lang->line('xin_import_employees');?></a></li>
                  <?php } ?>
