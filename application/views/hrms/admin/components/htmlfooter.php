...
<?php $this->load->view('hrms/admin/components/vendors/del_dialog');?>
<!-- jQuery 3 -->
...
<script type="text/javascript">var site_url = '<?php echo site_url(); ?>hrms/admin/';</script>
<script type="text/javascript">var base_url = '<?php echo site_url().'hrms/admin/'.$this->router->fetch_class(); ?>';</script>
...
<?php $this->load->view('hrms/admin/roles/role_values');?>
<?php } ?>
<?php if($this->router->fetch_class() =='organization'){?>
<?php $this->load->view('hrms/admin/components/vendors/organization_chart');?>
<?php } ?>
...
<?php if($this->router->fetch_method() =='projects_calendar'){?>
	<?php $this->load->view('hrms/admin/components/vendors/project_calendar');?>
<?php }?>
<?php if($this->router->fetch_method() =='quote_calendar'){?>
	<?php $this->load->view('hrms/admin/components/vendors/quote_calendar');?>
<?php }?>
<?php if($this->router->fetch_method() =='invoice_calendar'){?>
	<?php $this->load->view('hrms/admin/components/vendors/invoice_calendar');?>
<?php }?>
<?php if($this->router->fetch_method() =='projects_dashboard'){?>
	<?php $this->load->view('hrms/admin/components/vendors/project_dashboard_calendar');?>
<?php }?>
<?php if($this->router->fetch_method() =='tasks_calendar'){?>
	<?php $this->load->view('hrms/admin/components/vendors/tasks_calendar');?>
<?php }?>
<?php if($this->router->fetch_method() =='accounting_dashboard'){?>
<?php $this->load->view('hrms/admin/components/vendors/accounting_dashboard_calendar');?>
<?php }?>
<?php if($this->router->fetch_method() =='timecalendar'){?>
	<?php $this->load->view('hrms/admin/components/vendors/calendar_time');?>
<?php }?>
<?php if($this->router->fetch_class() =='calendar' || $this->router->fetch_class() =='dashboard'){?>
	<?php if($user[0]->user_role_id==1): ?>
		<?php $this->load->view('hrms/admin/components/vendors/full_calendar');?>
    <?php else:?>
