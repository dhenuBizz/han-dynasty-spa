...
<?php  } ?>
  ...
  <div class="user-panel">
    ...
    <div class="info">
      ...
      <a href="<?php echo site_url('hrms/admin/profile');?>"><i class="fa fa-user"></i></a>
      <?php if(in_array('60',$role_resources_ids)) { ?>
      <a href="<?php echo site_url('hrms/admin/settings');?>"><i class="fa fa-gear"></i></a>
      <?php } ?>
      <a href="<?php echo site_url('hrms/admin/logout');?>"><i class="fa fa-power-off"></i></a> </div>
  </div>
  ...
  <div class="user-panel">
        ...
        <div class="info">
          <p><?php echo $user_info[0]->first_name. ' '.$user_info[0]->last_name;?></p>
            ...
            <a href="<?php echo site_url('hrms/admin/profile?change_password=true')?>" class="link" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('xin_employee_password');?>"><i class="fa fa-key"></i></a>
            <a href="<?php echo site_url('hrms/admin/logout');?>" class="link" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('header_sign_out');?>"><i class="ion ion-power"></i></a>
        </div>
      </div>
  <?php else:?>
