...
<header class="main-header">
    ...
    <a href="<?php echo site_url('hrms/admin/dashboard/');?>" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <img src="<?= base_url(); ?>/assets/img/hans dynasty LOGO CI - Square_02-01.png" style="width:90px;">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <?php if($system[0]->module_chat_box=='true'){?>
        <a href="<?php echo site_url('hrms/admin/chat');?>" class="sidebar-toggle sidebar-toggle-hrsale-chat" role="button" title="<?php echo $this->lang->line('xin_hr_chat_box');?>">
        ...
        <ul class="nav navbar-nav">     
              ...
              <li><ul class="menu" style="max-height: 245px;"><li>
                ...
                <ul class="menu">
                  ...
                  <?php foreach($leaveapp as $leave_notify){?>
                    ...
                    ?>
                    <li><!-- start message -->
                    <a href="<?php echo site_url('hrms/admin/timesheet/leave_details/id')?>/<?php echo $leave_notify->leave_id;?>/">
                      <div class="pull-left">
                  ...
                  <?php foreach($nproject as $nprj) {?>
                    <li><!-- start message -->
                    <a href="<?php echo site_url('hrms/admin/project/detail')?>/<?php echo $nprj->project_id;?>/">
                      <div class="pull-left">
				  ...
				  ?>
                    <li><!-- start message -->
                    <a href="<?php echo site_url('hrms/admin/timesheet/task_details')?>/id/<?php echo $ntsk->task_id;?>/">
                      <div class="pull-left">
                  ...
                  <?php foreach($nannouncements as $n_annc) {?>
                    <li><!-- start message -->
                    <a href="<?php echo site_url('hrms/admin/announcement')?>/?is_notify=1">
                      <div class="pull-left">
                  ...
                  <?php foreach($ntickets as $n_ticket) {?>
                    <li><!-- start message -->
                      <a href="<?php echo site_url('hrms/admin/tickets/details')?>/<?php echo $n_ticket->ticket_id;?>">
                      <div class="pull-left">
          ...
          <!-- User Account: style can be found in dropdown.less -->
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu <?php echo $animated;?>">
                  ...
                  <li role="presentation">
                    <a role="menuitem" tabindex="-1" target="_blank" href="<?php echo site_url('hrms/jobs');?>"><i class="fa fa-newspaper-o"></i><?php echo $this->lang->line('left_jobs_listing');?>
                    </a>
                  </li>
                  <?php  } ?>
                  <?php  } ?>
                  ...
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/settings/constants');?>"> <i class="fa fa-align-justify"></i><?php echo $this->lang->line('left_constants');?></a></li>
                  <?php } ?>
                  <?php  if(in_array('393',$role_resources_ids)) { ?>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/custom_fields');?>"> <i class="fa fa-sliders"></i><?php echo $this->lang->line('xin_hrsale_custom_fields');?></a></li>
                  <?php } ?>
				  <?php  if($user[0]->user_role_id==1) { ?>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/roles');?>"> <i class="fa fa-unlock-alt"></i><?php echo $this->lang->line('xin_role_urole');?></a></li>
                  <?php } ?>
                  <?php  if(in_array('93',$role_resources_ids)) { ?>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/settings/modules');?>"> <i class="fa fa-life-ring"></i><?php echo $this->lang->line('xin_setup_modules');?></a></li>
                  <?php } ?>
                  <?php  if(in_array('63',$role_resources_ids)) { ?>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/settings/email_template');?>"> <i class="fa fa-envelope"></i><?php echo $this->lang->line('left_email_templates');?></a></li>
                  <?php } ?>
                  ...
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/reports');?>"> <i class="fa fa-bar-chart"></i><?php echo $this->lang->line('xin_hr_report_title');?></a></li>
                  <?php } ?>
                  <?php  if(in_array('92',$role_resources_ids)) { ?>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/import');?>"> <i class="fa fa-cloud-upload"></i><?php echo $this->lang->line('xin_hr_imports');?></a></li>
                  <?php } ?>
                  <?php  if(in_array('95',$role_resources_ids)) { ?>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/calendar/hr');?>"> <i class="fa fa-calendar"></i><?php echo $this->lang->line('xin_hr_calendar_title');?></a></li>
                  <?php } ?>
                  
				  <?php  if(in_array('62',$role_resources_ids)) { ?>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/settings/database_backup');?>"> <i class="fa fa-database"></i><?php echo $this->lang->line('header_db_log');?></a></li>
                  <?php } ?>
                  <?php  if(in_array('94',$role_resources_ids)) { ?>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/theme');?>"> <i class="fa fa-columns"></i><?php echo $this->lang->line('xin_theme_settings');?></a></li>
                  <?php } ?>
                  <?php if(in_array('118',$role_resources_ids)) { ?>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/settings/payment_gateway');?>"> <i class="fa fa-cc-visa"></i><?php echo $this->lang->line('xin_acc_payment_gateway');?></a></li>
                  <?php } ?>
                  <?php if($system[0]->module_orgchart=='true'){?>
            	  <?php if(in_array('96',$role_resources_ids)) { ?>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/organization/chart');?>"> <i class="fa fa-sitemap"></i><?php echo $this->lang->line('xin_org_chart_title');?></a></li>
                  <?php } ?>
                  <?php } ?>
                  <?php if(in_array('60',$role_resources_ids)) { ?>
                  <li class="divider"></li>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/settings');?>"> <i class="fa fa-cog text-aqua"></i><?php echo $this->lang->line('header_configuration');?></a></li>
                  <?php } ?>
                </ul>
              </li>
            <?php } ?>  
            ...
            <li class="dropdown">
                ...
                <?php $flag = '<img src="'.base_url().'uploads/languages_flag/'.$lang->language_flag.'">';?>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/dashboard/set_language/').$lang->language_code;?>"><?php echo $flag;?> &nbsp; <?php echo $lang->language_name;?></a></li>
                  <?php endforeach;?>
                  <?php if($system[0]->module_language=='true'){?>
            	<?php  if(in_array('89',$role_resources_ids)) { ?>
                  <li class="divider"></li>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/languages');?>"> <i class="fa fa-cog text-aqua"></i><?php echo $this->lang->line('left_settings');?></a></li>
                  <?php } ?>
                  <?php } ?>
                </ul>
              </li>
           ...
           <li class="dropdown">
            ...
            <ul class="dropdown-menu <?php echo $animated;?>">
              	<li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/profile');?>"> <i class="ion ion-person"></i><?php echo $this->lang->line('header_my_profile');?></a></li>
                  <li role="presentation">
                  <a data-toggle="modal" data-target=".policy" href="#"> <i class="fa fa-flag-o"></i><?php echo $this->lang->line('header_policies');?></a></li>
                  <?php if(in_array('60',$role_resources_ids)) { ?>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/settings');?>"> <i class="ion ion-settings"></i><?php echo $this->lang->line('left_settings');?></a></li>
                  <?php } ?>
                  
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/profile?change_password=true');?>"> <i class="fa fa-key"></i><?php echo $this->lang->line('header_change_password');?></a></li>
                  <li class="divider"></li>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/auth/lock');?>"> <i class="fa fa-lock"></i><?php echo $this->lang->line('xin_lock_user');?></a></li>
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('hrms/admin/logout');?>"> <i class="fa fa-power-off text-red"></i><?php echo $this->lang->line('header_sign_out');?></a></li>
                </ul>
          </li>
          <?php else:?>
		  ...
		  <ul class="dropdown-menu <?php echo $animated;?>">
              ...
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-5 text-center">
                    <a href="<?php echo site_url('hrms/admin/auth/lock')?>"><?php echo $this->lang->line('xin_lock_user');?></a>
                  </div>
                  <div class="col-xs-3 text-center">
                    <a data-toggle="modal" data-target=".policy" href="#"><i class="fa fa-flag-o"></i></a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="<?php echo site_url('hrms/admin/profile?change_password=true')?>"><?php echo $this->lang->line('xin_employee_password');?></a>
                  </div>
                </div>
                <!-- /.row -->
              </li>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo site_url('hrms/admin/profile');?>" class="btn btn-default btn-flat"><?php echo $this->lang->line('header_my_profile');?></a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo site_url('hrms/admin/logout');?>" class="btn btn-default btn-flat text-red"><?php echo $this->lang->line('header_sign_out');?></a>
                </div>
              </li>
            </ul>
          </li>
...
.btn-primary{
 background-color: #541728 !important !important;
}
#header_wrapper.ecom-header{
  background-image: url(../../headerImg/bg-2.jpg) !important;
