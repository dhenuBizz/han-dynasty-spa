...
if($system[0]->is_half_monthly==1){
	$bulk_form_url = 'hrms/admin/payroll/add_half_pay_to_all';
	$is_half_col = '12';
} else {
	$bulk_form_url = 'hrms/admin/payroll/add_pay_to_all';
	$is_half_col = '5';
}
?>
      ...
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            ...
            <?php echo form_open('hrms/admin/payroll/set_salary_details', $attributes, $hidden);?>
            <div class="row">
              ...
              <div class="col-md-<?php echo $colmd;?>">
                <div class="form-group">
                  <div class="form-actions">
                    <button type="submit" class="btn btn-primary" style="background-color: #541728 !important"> <i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('xin_search');?> </button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <div class="form-actions">
                    <button type="submit" class="btn btn-primary" style="background-color: #541728 !important"> <i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('xin_payroll_bulk_payment');?> </button>
                  </div>
                </div>
              </div>
            </div>
...
<div class="box <?php echo $get_animate;?>">
  <div class="box-header with-border">
    ...
    <div class="box-tools pull-right"> <a href="<?php echo site_url('hrms/admin/payroll/payment_history');?>">
        <button type="button" class="btn btn-xs btn-primary" style="background-color: #541728 !important"> <span class="fa fa-money"></span> <?php echo $this->lang->line('xin_payslip_history');?></button>
        </a> </div>
    <?php } ?>    
  </div>
  <div class="box-body">
