  ...
  <div class="<?php echo $cmdp_1st;?>">
    <div class="box mb-4">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right"> <a href="<?php echo site_url();?>hrms/admin/payroll/pdf_create/p/<?php echo $payslip_key;?>/" class="btn btn-social-icon mb-1 btn-outline-github" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $this->lang->line('xin_payroll_download_payslip');?>"><i class="fa fa-file-pdf-o"></i></a> </div>
      </div>
      <div class="box-body">
    ...
    <div class="box">
      <div class="box-body">
        <div class="form-group">
          ...
          <?php echo form_open('hrms/admin/payroll/update_payroll_status', $attributes2, $hidden2);?>
          <?php
			$data2 = array(
			  'name'        => 'payroll_id',
			  'id'          => 'payroll_id',
