...
<?php echo form_open('hrms/admin/overtime_request/add_request_attendance/', $attributes, $hidden);?>
<?php
	$data = array(
	  'name'        => 'employee_id_m',
	  'id'          => 'employee_id_m',
...
?>
  ...
  <div class="modal-footer">
    ...
    <button type="submit" class="btn btn-primary" style="background-color: #541728 !important"><?php echo $this->lang->line('xin_save');?></button>
  </div>
<?php echo form_close(); ?>
					...
					if (JSON.error != '') {
						...
						$('.save').prop('disabled', false);
							...
							if(attendance_date_m!='' && emp_id!='' && clock_in_m!='' && clock_out_m!='') {
								...
								"bDestroy": true,
								"ajax": {
									url : "<?php echo site_url("hrms/admin/overtime_request/overtime_request_list") ?>?employee_id="+emp_id+"&attendance_date="+attendance_date_m,
									type : 'GET'
								},
...
<?php echo form_open('hrms/admin/overtime_request/edit_attendance/'.$time_request_id, $attributes, $hidden);?>
<?php
	$data = array(
	  'name'        => 'emp_att',
	  'id'          => 'emp_att',
...
?>
  ...
  <div class="modal-footer">
    <button type="button" class="btn btn-secondary" data-dismiss="modal"><?php echo $this->lang->line('xin_close');?></button>
    <button type="submit" class="btn btn-primary save" style="background-color: #541728 !important"><?php echo $this->lang->line('xin_update');?></button>
  </div>
<?php echo form_close(); ?>
<script type="text/javascript">
$(document).ready(function(){
	...
	/* Edit Attendance*/
		...
		var xin_table2 = $('#xin_table').dataTable({
			"bDestroy": true,
			"ajax": {
				url : "<?php echo site_url("hrms/admin/overtime_request/overtime_request_list") ?>?employee_id="+emp_att+"&attendance_date="+attendance_date_e,
				type : 'GET'
			},
			"fnDrawCallback": function(settings){
			$('[data-toggle="tooltip"]').tooltip();          
