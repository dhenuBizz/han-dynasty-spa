      ...
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            ...
            <?php echo form_open('hrms/admin/timesheet/update_attendance', $attributes, $hidden);?>
            <?php
				$data = array(
				  'name'        => 'emp_id',
				  'id'          => 'emp_id',
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="form-actions box-footer">
                  <button type="submit" class="btn btn-primary" style="background-color: #541728 !important"> <i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('xin_get');?> </button>
                </div>
              </div>
            </div>
