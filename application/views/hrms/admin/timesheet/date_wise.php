  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-12">
        ...
        <?php echo form_open('hrms/admin/timesheet/datewise_attendance_list', $attributes, $hidden);?>
        <?php
				$data = array(
				  'type'        => 'hidden',
				  'name'        => 'user_id',
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <div class="form-group"><label for="xin_start_date">&nbsp;</label><br />
              <button type="submit" class="btn btn-primary save" style="background-color: #541728 !important"><?php echo $this->lang->line('xin_get');?></button>
            </div>
          </div>
          <?php } ?>
        </div>
