...
<?php echo form_open('hrms/admin/timesheet/edit_office_shift/'.$office_shift_id, $attributes, $hidden);?>
				...
				if (JSON.error != '') {
					...
					$('.edit-modal-data').modal('toggle');
						var xin_table = $('#xin_table').dataTable({
							"bDestroy": true,
							"ajax": {
								url : "<?php echo site_url("hrms/admin/timesheet/office_shift_list") ?>",
								type : 'GET'
							},
							dom: 'lBfrtip',
