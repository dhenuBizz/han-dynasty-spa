      ...
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            ...
            <?php echo form_open('hrms/admin/timesheet/leave_list', $attributes, $hidden);?>
            <div class="row">
              <div class="col-md-3">
              ...
              <div class="col-md-1"><label for="xin_get">&nbsp;</label><button name="hrsale_form" type="submit" class="btn btn-primary" style="background-color: #541728 !important"><i class="fa fa fa-check-square-o"></i> <?php echo $this->lang->line('xin_get');?></button>
            </div>
            </div>
  ...
  <div id="accordion">
    ...
    <div id="add_form" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
      <div class="box-body">
        ...
        <?php echo form_open('hrms/admin/timesheet/add_leave', $attributes, $hidden);?>
        <?php $leaave_cat = get_employee_leave_category($leave_categories,$session['user_id']);?>
        <div class="bg-white">
          <div class="box-block">
            <div class="row">
