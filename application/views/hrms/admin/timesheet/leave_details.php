                  ...
                  <table class="table table-striped m-md-b-0">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <a href="<?php echo site_url()?>hrms/admin/download?type=leave&filename=<?php echo $leave_attachment;?>"><?php echo $this->lang->line('xin_download');?></a>
                        <?php else:?>
        ...
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
                  ...
                  <?php echo form_open('hrms/admin/timesheet/update_leave_status/'.$leave_id, $attributes, $hidden);?>
                  <div class="row">
                    <div class="col-md-12">
