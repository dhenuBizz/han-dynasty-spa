    ...
    <div class="box mb-4">
      <div class="box-header">
        ...
        <div class="box-tools pull-right">
          <button type="button" class="btn btn-xs btn-primary" style="background-color: #541728 !important" id="add_attendance_btn" data-toggle="modal" data-target=".add-modal-data"> <span class="ion ion-md-add"></span> <?php echo $this->lang->line('xin_add_new');?></button>
        </div>
      </div>
      <div class="box-body">
