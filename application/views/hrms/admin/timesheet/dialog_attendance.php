...
<?php echo form_open('hrms/admin/timesheet/add_attendance/', $attributes, $hidden);?>
<?php
	$data = array(
	  'name'        => 'employee_id_m',
	  'id'          => 'employee_id_m',
 ...
 $(document).ready(function(){
		...
		$("#add_attendance").submit(function(e){
			...
			if(attendance_date_m!='' && emp_id!='' && clock_in_m!='' && clock_out_m!='') {
				...
				"bDestroy": true,
				"ajax": {
					url : "<?php echo site_url("hrms/admin/timesheet/update_attendance_list") ?>?employee_id="+emp_id+"&attendance_date="+attendance_date_m,
					type : 'GET'
				},
				dom: 'lBfrtip',
...
<?php echo form_open('hrms/admin/timesheet/edit_attendance/'.$time_attendance_id, $attributes, $hidden);?>
<?php
	$data = array(
	  'name'        => 'emp_att',
	  'id'          => 'emp_att',
...
$(document).ready(function(){
	...
	/* Edit Attendance*/
		...
		var xin_table2 = $('#xin_table').dataTable({
			"bDestroy": true,
			"ajax": {
				url : "<?php echo site_url("hrms/admin/timesheet/update_attendance_list") ?>?employee_id="+emp_att+"&attendance_date="+attendance_date_e,
				type : 'GET'
			},
			dom: 'lBfrtip',
			"buttons": ['csv', 'excel', 'pdf', 'print'], // colvis > if needed
