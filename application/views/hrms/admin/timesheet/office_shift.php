  ...
  <div id="accordion">
    ...
    <div id="add_form" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
      <div class="box-body">
        ...
        <?php echo form_open('hrms/admin/timesheet/add_office_shift', $attributes, $hidden);?>
        <div class="bg-white">
          <div class="box-block">
            <div class="row">
              <div class="col-md-10">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-2">
                    <button type="button" class="btn btn-primary clear-time" style="background-color: #541728 !important" data-clear-id="1"><?php echo $this->lang->line('xin_clear');?></button>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-md-2">
                    <button type="button" class="btn btn-primary clear-time" style="background-color: #541728 !important" data-clear-id="2"><?php echo $this->lang->line('xin_clear');?></button>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-md-2">
                    <button type="button" class="btn btn-primary clear-time"  style="background-color: #541728 !important" data-clear-id="3"><?php echo $this->lang->line('xin_clear');?></button>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-md-2">
                    <button type="button" class="btn btn-primary clear-time" style="background-color: #541728 !important" data-clear-id="4"><?php echo $this->lang->line('xin_clear');?></button>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-md-2">
                    <button type="button" class="btn btn-primary clear-time" style="background-color: #541728 !important" data-clear-id="5"><?php echo $this->lang->line('xin_clear');?></button>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-md-2">
                    <button type="button" class="btn btn-primary clear-time" style="background-color: #541728 !important" data-clear-id="6"><?php echo $this->lang->line('xin_clear');?></button>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-md-2">
                    <button type="button" class="btn btn-primary clear-time" style="background-color: #541728 !important" data-clear-id="7"><?php echo $this->lang->line('xin_clear');?></button>
                  </div>
                </div>
              </div>
            </div>
            <div class="form-actions box-footer">
              <button type="submit" class="btn btn-primary" style="background-color: #541728 !important"> <i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('xin_save');?> </button>
            </div>
          </div>
        </div>
