        ...
        <div class="row">
          ...
          <div class="col-sm-3 col-6">
            <div class="description-block">
              ...
              <span class="info-box-text"><a href="<?php echo site_url('hrms/admin/timesheet/office_shift/');?>"><?php echo $this->lang->line('xin_view_all');?> <i class="fa fa-arrow-circle-o-right"></i></a></span>
            </div>
            <!-- /.description-block -->
          </div>
        </div>
  ...
  <div class="col-md-4">
    <div class="box box-info">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right"> <a href="<?php echo site_url('hrms/admin/timesheet/leave/');?>">
            <button type="button" class="btn btn-xs btn-primary" style="background-color: #541728 !important"> <span class="fa fa-th-list"></span> <?php echo $this->lang->line('xin_manage_leaves');?></button>
            </a> </div>
      </div>
      <div class="box-body">
        <div class="row">
  ...
  <div class="col-md-4">
    <div class="box box-info">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right"> <a href="<?php echo site_url('hrms/admin/overtime_request/');?>">
            <button type="button" class="btn btn-xs btn-primary" style="background-color: #541728 !important"> <span class="fa fa-th-list"></span> <?php echo $this->lang->line('xin_overtime_request');?></button>
            </a> </div>
      </div>
      <div class="box-body">
        <div class="row">
  ...
  <div class="col-md-8">
    <div class="box box-info">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right"> <a href="<?php echo site_url('hrms/admin/timesheet/leave/');?>">
            <button type="button" class="btn btn-xs btn-primary" style="background-color: #541728 !important"> <span class="fa fa-calendar-plus-o"></span> <?php echo $this->lang->line('xin_view_all');?></button>
            </a> </div>
      </div>
      <div class="box-body">
          ...
          <tbody>
            ...
            <?php $role_resources_ids = $this->Xin_model->user_role_resource(); foreach(total_last_leaves() as $ls_leaves):?>
			  <?php
                ...
                ?>
            <tr>
                <td><a href="<?php echo site_url('hrms/admin/timesheet/leave_details/id/').$ls_leaves->leave_id.'/';?>"><?php echo $type_name;?></a></td>
  ...
  <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right"> <a href="<?php echo site_url('hrms/admin/timesheet/holidays/');?>">
            <button type="button" class="btn btn-xs btn-primary" style="background-color: #541728 !important"> <span class="fa fa-th-list"></span> <?php echo $this->lang->line('xin_view_all_holidays');?></button>
            </a> </div>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right"> <a href="<?php echo site_url('hrms/admin/overtime_request/');?>">
            <button type="button" class="btn btn-xs btn-primary" style="background-color: #541728 !important"> <span class="fa fa-th-list"></span> <?php echo $this->lang->line('xin_view_all');?></button>
            </a> </div>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
